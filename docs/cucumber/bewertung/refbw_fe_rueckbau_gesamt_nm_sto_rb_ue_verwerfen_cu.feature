...
# bis auf die Reihenfolge identisch wie refbw_fe_rueckbau_gesamt_sto_rb_nm_ue_verwerfen_cu.feature
...
Scenario: 02-nm-sto Rückbau aus vorgänger hier noch nachmeldung dann storno des rückbaus 
#----------------------------------------------------------------------------------------
Given I set the fake date to "22.01.2002"
