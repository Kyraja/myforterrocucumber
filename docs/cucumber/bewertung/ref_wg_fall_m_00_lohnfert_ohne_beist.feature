# *****************************************************************************
#  Name             : ref_wg_fall_m_00_lohnfert_ohne_beist.feature
#  Autor            : wane
#  Verantwortlich   : sih
#  Kontrolle        :
...
@FALL-LohnFertOhneBeistellung
Scenario: Lohnfertigung ohne Beistellung; Testumgebung 1


# Artikel anpassen
Given I open an editor "artikel" from table "(Part):(Product)" with command "UPDATE" for record "1vfall1"
...
# VK-Auftrag über 1vfall1 "Bauteil 2"
...
And I set field "schlag" to "OHNEBEIST_"
And I create a new row at the end of the table
And I set field "artex" to "1vfall1" in row 1
...
And I set field "bisuch" to "OHNEBEIST_" in row 1
...
# Lieferschein aus Bestellung "10-BE" -> Inland
...
And I set field "num4" to "10-LS"
And I set field "ueb" to "ja"
And I set field "vom" to "."
And I set field "kenn" to "FALL-LohnFertOhneBeistellung"
...
And I set field "num4" to "10LO-BE"
# Ausland
...
# Lieferschein aus Bestellung "10LO-BE" (Lohnfertigung) -> Ausland
...
And I set field "num4" to "10LO-LS"
And I set field "ueb" to "ja"
And I set field "vom" to "."
And I set field "kenn" to "FALL-LohnFertOhneBeistellung"
And I press button "offueb" in row 1
...
And I set field "num4" to "10LO-RE"
And I set field "ueb" to "ja"
And I set field "vom" to "."
# Inland
And I set field "lief" to "001fa1"
...
Given I open an editor "rueckmeldung1" from table "(Workorder):(WorkOrders)" with command "DONE" for record "OHNEBEIST_001"
And I set fields
	| sofort	| 1		|
	| bzeit		| 0,5	|
	| mzeit		| 8,5	|
...
Given I open an editor "rueckmeldung2" from table "(Workorder):(WorkOrders)" with command "DONE" for record "OHNEBEIST_002"
And I set fields
	| sofort	| 1		|
	| bzeit		| 0,5	|
	| mzeit		| 13	|
