@persistent
Feature: VERSAND_BEHAELTER_Einkaufslieferschein_MZ_Plausis.feature

# *****************************************************************************
#  Name             : VERSAND_BEHAELTER_Einkaufslieferschein_MZ_Plausis.feature
#  Autor            : carue
#  Verantwortlich   : carue
#  Kontrolle        : drpf
#  Funktion         : Plausis im Einkaufslieferschein bei MZs mit Behaeltern
...
And I create a Container "BehaelterM01" for packaging material "KLT" and search word "BEH_M01"
...
Then setting field "exbehnum" to "!BehaelterM01^exbehnum" in row 1 throws the exception "8346"
And I close the current editor
And I switch the current editor to editor "EKLieferschein_01"
And I close the current editor


Scenario: 02a Bei Angabe einer externen Behaelternummer darf das Packmittel nicht leer sein

Given I open an editor "EKLieferschein_02a" from table "(Purchasing):(PackingSlip)" with command "NEW" for record ""
And I set fields
    | lief      | KETTLER           |
    | vom       | .                 |
    | ebeleg    | Lieferschein_02a  |
And I append rows
	| artikel | mge |
	| PEDALE  | 11  |
...
And I close the current editor
And I switch the current editor to editor "EKLieferschein_02a"
And I close the current editor


Scenario: 02b Bei Angabe einer externen Behaelternummer muss ein Packmittel eingetragen werden

Given I open an editor "EKLieferschein_02b" from table "(Purchasing):(PackingSlip)" with command "NEW" for record ""
And I set fields
    | lief      | KETTLER           |
    | vom       | .                 |
    | ebeleg    | Lieferschein_02b  |
And I append rows
	| artikel | mge |
	| PEDALE  | 11  |
...
And I close the current editor
And I switch the current editor to editor "EKLieferschein_02b"
And I close the current editor


Scenario: 02c Packmittel muss Behaelter, Palette oder Container sein

Given I open an editor "EKLieferschein_02c" from table "(Purchasing):(PackingSlip)" with command "NEW" for record ""
And I set fields
    | lief      | KETTLER           |
    | vom       | .                 |
    | ebeleg    | Lieferschein_02c  |
And I append rows
	| artikel | mge |
	| PEDALE  | 11  |
...
And I close the current editor
And I switch the current editor to editor "EKLieferschein_02c"
And I close the current editor


Scenario: 03a Gleiche Behaelternummer muss gleichen Platz in allen Zeilen haben, in LS und MZ

Given I open an editor "EKLieferschein_03a" from table "(Purchasing):(PackingSlip)" with command "NEW" for record ""
And I set fields
    | lief      | KETTLER           |
    | vom       | .                 |
    | ebeleg    | Lieferschein_03a  |
    | ueb       | ja                |
And I append rows
	| artikel | mge | exbehnum | platz | packm |
	| PEDALE  | 200 | MZ03_A1  | F1    | KLT   |
	| RAD     | 200 | MZ03_A1  | F1    | KLT   |
...
And I append rows
	...
	| F1     | 100    | MZ03_A3  | KLT   |
And I save the current editor
And I switch the current editor to editor "EKLieferschein_03a"
...
Given I open an editor "EKLieferschein_03b" from table "(Purchasing):(PackingSlip)" with command "NEW" for record ""
And I set fields
    | lief      | KETTLER           |
    | vom       | .                 |
    | ebeleg    | Lieferschein_03b  |
    | ueb       | ja                |
And I append rows
	| artikel | mge | exbehnum | platz | packm |
	| PEDALE  | 200 | MZ03_B1  | F1    | KLT   |
	| RAD     | 200 | MZ03_B1  | F1    | KLT   |
...
And I append rows
	...
	| F1     | 100    | MZ03_B3  | KLT   |
And I save the current editor
And I switch the current editor to editor "EKLieferschein_03b"
...
Given I open an editor "EKLieferschein_03c" from table "(Purchasing):(PackingSlip)" with command "NEW" for record ""
And I set fields
    | lief      | KETTLER           |
    | vom       | .                 |
    | ebeleg    | Lieferschein_03c  |
    | ueb       | ja                |
And I append rows
	| artikel | mge | exbehnum | platz | packm |
	| PEDALE  | 200 | MZ03_C1  | F1    | KLT   |
...
And I append rows
	...
	| F1     | 100    | MZ03_C2  | KLT   |
And I save the current editor
And I switch the current editor to editor "EKLieferschein_03c"
And I save the current editor


Scenario: 03d Gleiche Behaelternummer mit unterschiedlichen Plaetzen in LS und MZ fuehrt zu Fehler

Given I open an editor "EKLieferschein_03d" from table "(Purchasing):(PackingSlip)" with command "NEW" for record ""
And I set fields
    | lief      | KETTLER           |
    | vom       | .                 |
    | ebeleg    | Lieferschein_03d  |
    | ueb       | ja                |
And I append rows
	| artikel | mge | exbehnum | platz | packm |
	| PEDALE  | 200 | MZ03_D1  | F1    | KLT   |
...
And I append rows
	...
	| F1     | 100    | MZ03_D2  | KLT   |
And I save the current editor
And I switch the current editor to editor "EKLieferschein_03d"
# Fehler 8391: Gleiche Behaelternummer, abweichender Lagerplatz.
And saving the current editor throws the exception "8391"
And I close the current editor
...
Given I open an editor "EKLieferschein_04a" from table "(Purchasing):(PackingSlip)" with command "NEW" for record ""
And I set fields
    | lief      | KETTLER           |
    | vom       | .                 |
    | ebeleg    | Lieferschein_04a  |
    | ueb       | ja                |
And I append rows
	| artikel | mge | exbehnum | platz | packm |
	| PEDALE  | 200 | MZ04_A1  | F1    | KLT   |
...
And I append rows
	...
	| F1     | 100    | MZ04_A2  | KLT   |
And I save the current editor
And I switch the current editor to editor "EKLieferschein_04a"
And I save the current editor


Scenario: 04b Gleiche Behaelternummer mit unterschiedlichen Packmitteln in LS und MZ fuehrt zu Fehler

Given I open an editor "EKLieferschein_04b" from table "(Purchasing):(PackingSlip)" with command "NEW" for record ""
And I set fields
    | lief      | KETTLER           |
    | vom       | .                 |
    | ebeleg    | Lieferschein_04b  |
    | ueb       | ja                |
And I append rows
	| artikel | mge | exbehnum | platz | packm   |
	| PEDALE  | 200 | MZ04_B1  | F1    | SKARTON |
...
And I append rows
	...
	| F1     | 100    | MZ04_B2  | KLT   |
And I save the current editor
And I switch the current editor to editor "EKLieferschein_04b"
...
Given I open an editor "EKLieferschein_04c" from table "(Purchasing):(PackingSlip)" with command "NEW" for record ""
And I set fields
    | lief      | KETTLER           |
    | vom       | .                 |
    | ebeleg    | Lieferschein_04c  |
    | ueb       | ja                |
And I append rows
	| artikel | mge | exbehnum | platz | packm |
	| PEDALE  | 200 | MZ04_C1  | F1    | KLT   |
	| RAD     | 200 | MZ04_C1  | F1    | KLT   |
...
And I append rows
	...
	| F1     | 100    | MZ04_C3  | KLT   |
And I save the current editor
And I switch the current editor to editor "EKLieferschein_04c"
And I press button "mzsubm" to open a subeditor for "Materialzuordnung_04c2" in row 2
And I delete all rows
And I append rows
	| lpsuch | zuomge | exbehnum | packm   |
	| F1     | 100    | MZ04_C2  | SKARTON |
	| F1     | 100    | MZ04_C3  | SKARTON |
And I save the current editor
And I switch the current editor to editor "EKLieferschein_04c"
# Fehler 8371: Gleiche Behaelternummer, unterschiedliche Packmittel.
And saving the current editor throws the exception "8371"
...
Given I open an editor "EKLieferschein_05a" from table "(Purchasing):(PackingSlip)" with command "NEW" for record ""
And I set fields
    | lief      | KETTLER           |
    | vom       | .                 |
    | ebeleg    | Lieferschein_05a  |
    | ueb       | ja                |
And I append rows
	| artikel | mge | platz |
	| PEDALE  | 200 | F1    |
...
And I append rows
	...
	| F1     | 100    | MZ05_A1  | KLT   | abc  |
	| F1     | 100    | MZ05_A1  | KLT   | cde  |
And I save the current editor
And I switch the current editor to editor "EKLieferschein_05a"
And I save the current editor


Scenario: 05b Gleiche Behaelternummer in 2 MZ-Zeilen mit gleichen Gebindeinformationen fuehrt zu Fehler

Given I open an editor "EKLieferschein_05b" from table "(Purchasing):(PackingSlip)" with command "NEW" for record ""
And I set fields
    | lief      | KETTLER           |
    | vom       | .                 |
    | ebeleg    | Lieferschein_05b  |
    | ueb       | ja                |
And I append rows
	| artikel | mge | platz |
	| PEDALE  | 200 | F1    |
...
And I close the current editor
And I switch the current editor to editor "EKLieferschein_05b"
And I close the current editor
