# *****************************************************************************
#  Name             : ref_zv_de_QR_QRR_cu.feature
#  Autor            : rem
#  Verantwortlich   : hc
#  Kontrolle        :
#  Funktion         : Test der QR-Zahlungen QRR (Schweizer Zahlungsverkehr), wenn Inland DE und Inlandswaehrung EUR
#  ref              : ref_zv_de_QR_QRR_cu
# *****************************************************************************
@persistent
Feature: ref_zv_de_QR_QRR_cu.feature
Background:
Given I set the fake date to "31.12.2022"
# legt Bestellvorschlag und Rechnung aus Bestellung an und zahlt aus deutschem Mandanten eine schweizer QR Rechnung im Inlandszv
# =============================================================================

Scenario: Bestellvorschlag anlegen
...
And I set field "selopwaehr" to "CHF"
...
Scenario: Bankdatei aufbereiten
...
Then field "tqrreferenz" has value "210000000003139471430009017" in row 1
Then field "ttlnr" has value "CH4431999123000889012" in row 1
Then field "trefcheck" has value "QRR" in row 1
# Anzeige des Rebetrages nur, weil keine Sammlung gemacht wird
Then field "trebetr" has value "163.50" in row 1
