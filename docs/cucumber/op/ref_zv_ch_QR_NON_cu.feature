# *****************************************************************************
#  Name             : ref_zv_ch_QR_NON_cu.feature
#  Autor            : rem
#  Verantwortlich   : hc
#  Kontrolle        :
#  Funktion         : Test der QR-Zahlungen NON (Schweizer Zahlungsverkehr), wenn Inland CH und Inlandswaehrung CHF
#  ref              : ref_zv_ch_QR_NON_cu
# *****************************************************************************

@persistent
Feature: ref_zv_ch_QR_NON_cu.feature
Background:
Given I set the fake date to "31.12.2022"
Scenario: IBAN-Zahlungen_ohne_Referenz
# =============================================================================
...
Then field "tzabetr" has value "194.57" in row 1
