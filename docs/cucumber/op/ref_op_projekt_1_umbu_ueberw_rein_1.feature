# *****************************************************************************
#  Name             : ref_op_projekt_1_umbu_ueberw_rein_1.feature
#  Verantwortlich   : hc
#  Kontrolle        :
#  Funktion         : OPs umbuchen in "Zahlungsausgang - Bankkontoauszüge", Umbuchen projektrein, Projektkostenrechnung aktiviert
#  Verwendung       : ref_op_projekt_1_umbu_ueberw_rein_1_cu
# *****************************************************************************
@persistent
Feature: ref_op_projekt_1_umbu_ueberw_rein_1.feature

Background:
Given I set the fake date to "31.12.2022"
# =============================================================================

Scenario: Zahlungsausgang - Banküberweisungen, Vorbelegung der Sammlerdaten im Bezug auf Projekt testen
...
# ------------------------------------------------------------------------------------------------------------------------------
# OP-Bearbeitung NEU, "Zahlungsausgang - Banküberweisungen", Kopfelder vorbelegen
# ------------------------------------------------------------------------------------------------------------------------------

Given I open an editor "Test_LI_UMBU-1" from table "102:01" with command "NEW" for record ""
...
Then field "ebeleggko" has value "Test LI UMBU-1" in row 1
...
Then field "ebeleggko" has value "Test LI UMBU-1" in row 2
...
Then field "ebeleggko" has value "Test LI UMBU-1" in row 3
...
Then field "ebeleggko" has value "Test LI UMBU-1" in row 4
...
Then field "ebeleggko" has value "Test LI UMBU-1" in row 5
...
Then field "ebeleggko" has value "Test LI UMBU-1" in row 6
...
Then field "ebeleggko" has value "Test LI UMBU-1" in row 7
...
Then field "ebeleggko" has value "Test LI UMBU-1" in row 8
...
Then field "ebeleggko" has value "Test LI UMBU-1" in row 9
...
Then field "ebeleggko" has value "Test LI UMBU-1" in row 10
...
Then field "ebeleggko" has value "Test LI UMBU-1" in row 11
...
Then field "ebeleggko" has value "Test LI UMBU-1" in row 12
...
Then field "ebeleggko" has value "Test LI UMBU-1" in row 13
...
Then field "ebeleggko" has value "Test LI UMBU-1" in row 14
...
Then field "ebeleggko" has value "Test LI UMBU-1" in row 15
...
Then field "ebeleggko" has value "Test LI UMBU-1" in row 16
