# *****************************************************************************
#  Name             : ref_zv_ch_QR_SCOR_cu.feature
#  Autor            : rem
#  Verantwortlich   : hc
#  Kontrolle        :
#  Funktion         : Test der QR-Zahlungen SCOR (Schweizer Zahlungsverkehr), wenn Inland CH und Inlandswaehrung CHF
#  ref              : ref_zv_ch_QR_SCOR_cu
# *****************************************************************************

@persistent
Feature: ref_zv_ch_QR_SCOR_cu.feature
Background:
Given I set the fake date to "31.12.2022"
Scenario: QR-Zahlungen SCOR von der Rechnung bis zur Zahlung
