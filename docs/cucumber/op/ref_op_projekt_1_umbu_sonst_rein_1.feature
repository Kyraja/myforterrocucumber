# *****************************************************************************
#  Name             : ref_op_projekt_1_umbu_sonst_rein_1.feature
#  Verantwortlich   : hc
#  Kontrolle        :
#  Funktion         : OPs umbuchen in "Sonstige Zahlungen", Umbuchen projektrein, Projektkostenrechnung aktiviert
#  Verwendung       : ref_op_projekt_1_umbu_sonst_rein_1_cu
# *****************************************************************************
@persistent
Feature: ref_op_projekt_1_umbu_sonst_rein_1.feature

Background:
Given I set the fake date to "31.12.2022"
# =============================================================================

Scenario: Sonstige Zahlungen, Zahlungsausgang, Vorbelegung der Sammlerdaten im Bezug auf Projekt testen
...
# ------------------------------------------------------------------------------------------------------------------------------
# OP-Bearbeitung NEU, "Sonstige Zahlungen", Zahlungsausgang, Kopfelder vorbelegen
# ------------------------------------------------------------------------------------------------------------------------------

Given I open an editor "Test_LI_UMBU-1" from table "102:03" with command "NEW" for record ""
