...
Scenario: editable_new_entry_fields_general
    ...
    Given I open an editor "BuchungA" from table "(RecurringEntry):(FinancialEntryTemplate)" with command "NEW" for record ""
    And I set field "such" to "B3"
    ...
    Given I open an editor "BuchungB" from table "(RecurringEntry):(FinancialEntryTemplate)" with command "NEW" for record ""
    And I set field "such" to "B4"
