...
Scenario: editable_new_entry_fields_set_of_books
    Given I open an editor "Buchung6" from table "(RecurringEntry):(StatisticalEntryTemplate)" with command "NEW" for record "" 
...
Scenario: editable_new_entry_fields_row_general
    Given I open an editor "Buchung7" from table "(RecurringEntry):(StatisticalEntryTemplate)" with command "NEW" for record "" 
...
Scenario: editable_new_entry_fields_row_statistical
    Given I open an editor "Buchung8" from table "(RecurringEntry):(StatisticalEntryTemplate)" with command "NEW" for record "" 
    And I create a new row at the end of the table
    And I set field "konto" to "99800" in row 1
...
Scenario: editable_new_entry_fields_controlling
    Given I open an editor "Buchung14" from table "(RecurringEntry):(StatisticalEntryTemplate)" with command "NEW" for record "" 
    And I create a new row at the end of the table
...
Scenario: editable_new_entry_fields_row_asset
    Given I open an editor "Buchung15" from table "(RecurringEntry):(StatisticalEntryTemplate)" with command "NEW" for record "" 
    And I create a new row at the end of the table
    Then field "anlage" is not modifiable in row 1 
