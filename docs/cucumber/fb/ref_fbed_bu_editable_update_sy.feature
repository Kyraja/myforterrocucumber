...
Scenario: editable_new_entry_fields_general
    ...
    Given I open an editor "BuchungA" from table "(Entry):(Entry)" with command "NEW" for record ""
    And I set field "such" to "UPDSY1"
    ...
    Given I open an editor "BuchungB" from table "(Entry):(Entry)" with command "NEW" for record ""
    And I set field "such" to "UPDSY2"
 ...
 Given I open an editor "Buchung1" from table "(Entry):(Entry)" with command "UPDATE" for record "UPDSY1"
    ...
    Then field "beleg" is not modifiable
...
Scenario: editable_update_sy_entry_fields_only_fibu
 
 Given I open an editor "Buchung1" from table "(Entry):(Entry)" with command "UPDATE" for record "UPDSY1"
    Then field "ebeleg" is not modifiable
    Then field "buartrdiff" is not modifiable
    And I close the current editor
     
Scenario: editable_update_sy_entry_fields_consolidation
...
Scenario: editable_update_sy_entry_fields_currency    
 Given I open an editor "Buchung2" from table "(Entry):(Entry)" with command "UPDATE" for record "UPDSY1"
    Then field "iwbu" is not modifiable
    Then field "ewbu" is not modifiable
...
Scenario: editable_update_sy_entry_fields_payment
    Given I open an editor "Buchung3" from table "(Entry):(Entry)" with command "UPDATE" for record "UPDSY1"
    Then field "zbed" is not modifiable
    Then field "zbedschl" is not modifiable
    Then field "vdat" is not modifiable
    Then field "term" is not modifiable
...
Scenario: editable_update_sy_entry_fields_action
    Given I open an editor "Buchung4" from table "(Entry):(Entry)" with command "UPDATE" for record "UPDSY1"
    Then field "storno" is not modifiable
    Then field "ktausch" is not modifiable
    Then field "knetto" is not modifiable
    Then field "nettoalle" is not modifiable
    Then field "bubelnw" is not modifiable
    Then field "summe" is modifiable    
    Then field "ksteuer" is not modifiable
    Then field "butyp" is not modifiable
    And I close the current editor
    
Scenario: editable_update_sy_entry_fields_head_tax
    Given I open an editor "Buchung5" from table "(Entry):(Entry)" with command "UPDATE" for record "UPDSY1"
    Then field "butyp" is not modifiable
    Then field "sabw" is not modifiable
    Then field "ustid" is modifiable
    Then field "klm" is not modifiable
...
Scenario: editable_update_sy_entry_fields_set_of_books
    Given I open an editor "Buchung6" from table "(Entry):(Entry)" with command "UPDATE" for record "UPDSY1" 
    Then field "inbukreis1" is not modifiable
    Then field "bukreis1" is not modifiable
    Then field "inbunr1" is not modifiable
    Then field "exbunr1" is modifiable
    Then field "inbukreis2" is not modifiable
    Then field "bukreis2" is not modifiable
    Then field "inbunr2" is not modifiable
    Then field "exbunr2" is modifiable
    Then field "inbukreis3" is not modifiable
...
Scenario: editable_update_sy_entry_fields_row_general
    Given I open an editor "Buchung7" from table "(Entry):(Entry)" with command "UPDATE" for record "UPDSY2" 
...
Scenario: editable_update_sy_entry_fields_row_advance_payment
    Given I open an editor "Buchung8" from table "(Entry):(Entry)" with command "UPDATE" for record "UPDSY1" 
...
Scenario: editable_update_sy_entry_fields_kv
    Given I open an editor "Buchung9" from table "(Entry):(Entry)" with command "UPDATE" for record "UPDSY1" 
...
Scenario: editable_update_sy_entry_fields_w2
    Given I open an editor "Buchung10" from table "(Entry):(Entry)" with command "UPDATE" for record "UPDSY2" 
    ...
    Then field "w2hbetr" is not modifiable in row 2
    Then field "w2gjahr" is not modifiable in row 2
    And I close the current editor 

Scenario: editable_update_sy_entry_fields_fibu_general
    Given I open an editor "Buchung11" from table "(Entry):(Entry)" with command "UPDATE" for record "UPDSY1" 
...
Scenario: editable_update_sy_entry_fields_row_tax
    Given I open an editor "Buchung12" from table "(Entry):(Entry)" with command "UPDATE" for record "UPDSY1" 
...
#
    ...
    Then field "znetto" is not modifiable in row 1
...
Scenario: editable_update_sy_entry_fields_row_currency
    Given I open an editor "Buchung12" from table "(Entry):(Entry)" with command "UPDATE" for record "UPDSY1" 
