...
Scenario: editable_new_entry_fields_general
    ...
    Given I open an editor "BuchungA" from table "(RecurringEntry):(StatisticalEntryTemplate)" with command "NEW" for record ""
    And I set field "such" to "K3" 
 ...
 Given I open an editor "Buchung1" from table "(RecurringEntry):(StatisticalEntryTemplate)" with command "UPDATE" for record "K3"
...
Scenario: editable_update_sy_entry_fields_currency    
 Given I open an editor "Buchung2" from table "(RecurringEntry):(StatisticalEntryTemplate)" with command "UPDATE" for record "K3"
    Then field "iwbu" is not modifiable
    And I close the current editor
    
        
Scenario: editable_update_sy_entry_fields_action
    Given I open an editor "Buchung4" from table "(RecurringEntry):(StatisticalEntryTemplate)" with command "UPDATE" for record "K3"
...
Scenario: editable_update_sy_entry_fields_set_of_books
    Given I open an editor "Buchung6" from table "(RecurringEntry):(StatisticalEntryTemplate)" with command "UPDATE" for record "K3"
...
Scenario: editable_update_sy_entry_fields_row_general
    Given I open an editor "Buchung7" from table "(RecurringEntry):(StatisticalEntryTemplate)" with command "UPDATE" for record "K3"
...
Scenario: editable_update_sy_entry_fields_row_statistical
    Given I open an editor "Buchung8" from table "(RecurringEntry):(StatisticalEntryTemplate)" with command "UPDATE" for record "K3" 
