...
Scenario: editable_new_entry_fields_kv
    Given I open an editor "Buchung9" from table "(Entry):(Entry)" with command "NEW" for record "" 
    And I create a new row at the end of the table
...
Scenario: editable_new_entry_fields_controlling
    Given I open an editor "Buchung14" from table "(Entry):(Entry)" with command "NEW" for record "" 
    And I create a new row at the end of the table
...
Scenario: editable_new_entry_fields_row_asset
    Given I open an editor "Buchung15" from table "(Entry):(Entry)" with command "NEW" for record "" 
    And I create a new row at the end of the table
    Then field "anlage" is not modifiable in row 1 
