...
Scenario: editable_new_entry_fields_general
    ...
    Given I open an editor "BuchungC" from table "(Entry):(Entry)" with command "NEW" for record ""
    And I set field "such" to "UPDWT1"
    ...
    Given I open an editor "BuchungD" from table "(Entry):(Entry)" with command "NEW" for record ""
    And I set field "such" to "UPDWT2"
    And I set field "budat" to "02.02.2002"
 ...
 Given I open an editor "Buchung1" from table "(Entry):(Entry)" with command "UPDATE" for record "BUTTON1"
    ...
    Then field "ursacheref" is modifiable
...
Scenario: editable_update_w_entry_fields_currency    
 Given I open an editor "Buchung2" from table "(Entry):(Entry)" with command "UPDATE" for record "BUTTON1"
...
Scenario: editable_update_w_entry_fields_payment
    Given I open an editor "Buchung3" from table "(Entry):(Entry)" with command "UPDATE" for record "BUTTON1"
...
Scenario: editable_update_w_entry_fields_action
    Given I open an editor "Buchung4" from table "(Entry):(Entry)" with command "UPDATE" for record "BUTTON1"
...
Scenario: editable_update_w_entry_fields_head_tax
    Given I open an editor "Buchung5" from table "(Entry):(Entry)" with command "UPDATE" for record "BUTTON1"
    Then field "butyp" is modifiable
    ...
    Then field "artst" is modifiable
...
Scenario: editable_update_w_entry_fields_set_of_books
    Given I open an editor "Buchung6" from table "(Entry):(Entry)" with command "UPDATE" for record "BUTTON1" 
...
Scenario: editable_update_w_entry_fields_row_general
    Given I open an editor "Buchung7" from table "(Entry):(Entry)" with command "UPDATE" for record "UPDWT2" 
...
Scenario: editable_update_w_entry_fields_row_advance_payment
    Given I open an editor "Buchung8" from table "(Entry):(Entry)" with command "UPDATE" for record "UPDWT1" 
...
Scenario: editable_update_w_entry_fields_kv
    Given I open an editor "Buchung9" from table "(Entry):(Entry)" with command "UPDATE" for record "UPDWT1" 
...
Scenario: editable_update_w_entry_fields_w2
    Given I open an editor "Buchung10" from table "(Entry):(Entry)" with command "UPDATE" for record "UPDWT2" 
...
Scenario: editable_update_w_entry_fields_fibu_general
    Given I open an editor "Buchung11" from table "(Entry):(Entry)" with command "UPDATE" for record "UPDWT1" 
...
Scenario: editable_update_w_entry_fields_row_tax
    Given I open an editor "Buchung12" from table "(Entry):(Entry)" with command "UPDATE" for record "UPDWT1" 
