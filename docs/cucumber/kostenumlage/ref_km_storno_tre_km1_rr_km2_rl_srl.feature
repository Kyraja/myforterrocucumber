...
# *****************************************************************************
@persistent
Feature: BW2-1520 Kostenumlage auf Teilrechnungen stornieren
...
#            deshalb nur teilweise umbuchung in der km!
#                        ~~~~~~~~~~~~~~~~~~~
# ---------------------------------------------------------------------------------------------
...
# *********************************************************
# zweizeilige kostenumlage nur stornieren nicht rückführen
# *********************************************************
...
# mit-km1-nach-teilrechnung #And I set field "such" to "S110"
# mit-km1-nach-teilrechnung #And I save the current editor
...
# mit-km2-nach-restrechnung #And I set field "such" to "S110B"
# mit-km2-nach-restrechnung #And I save the current editor


# Rücklieferschein zu LSa anlegen
Given I open an editor "rls-790" from table "(Purchasing):(PackingSlip)" with command "RETURN" for record "+11-15-2l"
And I set field "num4" to "11152rl"
And I set field "vom" to "."
And I set field "mge" to "-15" in row 2
And I save the current editor

# Ruecklieferschein buchen (muss funktionieren, keine Kostenumlagen)
Given I open an editor "rls-790" from table "(Purchasing):(PackingSlip)" with command "UPDATE" for record "11152rl"
And I set field "ueb" to "ja"
And I save the current editor

Given I open an editor "srls-790" from table "(Purchasing):(PackingSlip)" with command "REVERSAL" for record "11152rl"
And I save the current editor
