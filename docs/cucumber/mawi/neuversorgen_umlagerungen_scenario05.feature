# *****************************************************************************
#  Name             : neuversorgen_umlagerungen_scenario05.feature
#  Autor            : carue
#  Verantwortlich   : carue
#  Kontrolle        : ak
#  Funktion         : Testet Neuversorgung von umgelagerten Bestaenden
#                     nach Rueckbuchung auf Abgaenge
#
# Test zu Scenario aus BW2-1083
#
# *****************************************************************************
@persistent
Feature: neuversorgen_umlagerungen_scenario05.feature
Background:
Given I set the fake date to "12.01.95"

Scenario: Bestaende fuer Bauteile auf 0 setzen, Fertigteil kopieren
And I set StorageQuantity to zero for Product "RAHMEN" on StorageLocation "MLF01" with document "Scenario5"
And I set StorageQuantity to zero for Product "RAD" on StorageLocation "MLF01" with document "Scenario5"
And I set StorageQuantity to zero for Product "SATTEL" on StorageLocation "MLF01" with document "Scenario5"
And I set StorageQuantity to zero for Product "PEDALE" on StorageLocation "MLF01" with document "Scenario5"

# Fertigteil FAHRRAD kopieren
Given I open an editor "Fahrrad" from table "(Part):(Product)" with command "COPY" for record "FAHRRAD"
And I set field "such" to "FAHRRAD-05"
...
#Then field "lemge" has value "<lmenge>" in row 2
#Then field "leinheit" has value "<leinheit>" in row 2
...
Given I open an editor "Rueckmeldung1" from table "(Workorder):(WorkOrders)" with command "DONE" for record "RAD05_000"
...
Given I open StockMovementJournal "Journal1" for Product "FAHRRAD-05" and cause of entry "Rückmeldung Fertigung" and transaction "Rueckmeldung1" with command "VIEW"
Then field "buarta" has value "Zugang"
Then field "mge" has value "10"
And I close the current editor

# Platzmenge pruefen
Given I query StorageQuantity for Product "FAHRRAD-05" on StorageLocation "MLF01"
...
# Bewertung pruefen
Given I open an editor "Bewertung1" from table "(Valuation):(Valuation)" with command "VIEW" for search criteria "$,,artikel=FAHRRAD-05;detursache=Rückmeldung Fertigung;@ablageart=lebendig;@richtung=rückwärts;@maxtreffer=1"
...
Given I open an editor "JournalAb1" from table "(Journal):(Journal)" with command "VIEW" for record "$,,artikel==FAHRRAD-05;detursache==Lieferschein Verkauf;platz==MLF01"
...
Given I open an editor "JournalAb2" from table "(Journal):(Journal)" with command "VIEW" for record "$,,artikel==FAHRRAD-05;detursache==Lieferschein Verkauf;platz==ABLA"
Then field "buarta" has value "Abgang"
Then field "mge" has value "3"
Then the table has 0 rows
And I close the current editor

Given I open an editor "JournalAb3" from table "(Journal):(Journal)" with command "VIEW" for record "$,,artikel==FAHRRAD-05;detursache==Lieferschein Verkauf;platz==ZLQM"
Then field "buarta" has value "Abgang"
...
Given I query StorageQuantity for Product "FAHRRAD-05" on StorageLocation "ABLA"
Then StorageQuantities have values
    | gebmge | lj^id          | orig^id | bewmge | bewlj^id       | beworig^id |
    | -3     | !JournalAb2^id | (0,0,0) | -3     | !JournalAb2^id | (0,0,0)    |
And I close the current editor

Given I query StorageQuantity for Product "FAHRRAD-05" on StorageLocation "ZLQM"
Then StorageQuantities have values
    | gebmge | lj^id          | orig^id | bewmge | bewlj^id       | beworig^id |
...
# Bewertung pruefen
Given I open an editor "BewertungAb1" from table "(Valuation):(Valuation)" with command "VIEW" for search criteria "$,,artikel==FAHRRAD-05;detursache==Lieferschein Verkauf;mge==5;@ablageart=lebendig;"
...
Given I open an editor "BewertungAb2" from table "(Valuation):(Valuation)" with command "VIEW" for search criteria "$,,artikel==FAHRRAD-05;detursache==Lieferschein Verkauf;mge==3;@ablageart=lebendig;"
...
Given I open an editor "BewertungAb3" from table "(Valuation):(Valuation)" with command "VIEW" for search criteria "$,,artikel==FAHRRAD-05;detursache==Lieferschein Verkauf;mge==7;@ablageart=lebendig;"
...
And I transfer StorageQuantity of "10" for Product "FAHRRAD-05" from StorageLocation "MLF01" to "ABLA" with document "Umlagern5-1"

# Zugangsjournal der Umlagerung
Given I open an editor "JournalUmZu1" from table "(Journal):(Journal)" with command "VIEW" for record "$,,artikel==FAHRRAD-05;detursache==Manuelle Umbuchung;buarta==Zugang;mge==10"
Then field "buarta" has value "Zugang"
...
Given I open an editor "BewertungUmZu1" from table "(Valuation):(Valuation)" with command "VIEW" for search criteria "$,,artikel==FAHRRAD-05;detursache==Manuelle Umbuchung;buart==Zugang;@ablageart=lebendig;@richtung=rückwärts;@maxtreffer=1"
...
Given I open an editor "BewertungUmAb1" from table "(Valuation):(Valuation)" with command "VIEW" for search criteria "$,,artikel==FAHRRAD-05;detursache==Manuelle Umbuchung;buart==Abgang;@ablageart=lebendig;@richtung=rückwärts;@maxtreffer=1"
...
Given I open an editor "BewertungAb2b" from table "(Valuation):(Valuation)" with command "VIEW" for search criteria "$,,artikel==FAHRRAD-05;detursache==Lieferschein Verkauf;mge==3;@ablageart=lebendig;"
Then field "ppsref^id" has value equal to field "id" from editor "JournalAb2"
...
And I transfer StorageQuantity of "7" for Product "FAHRRAD-05" from StorageLocation "ABLA" to "ZLQM" with document "Umlagern5-2"

# Zugangsjournal der Umlagerung
Given I open an editor "JournalUmZu2" from table "(Journal):(Journal)" with command "VIEW" for record "$,,artikel==FAHRRAD-05;detursache==Manuelle Umbuchung;buarta==Zugang;mge==7"
Then field "buarta" has value "Zugang"
Then field "detursache" has value "Manuelle Umbuchung"
...
# Umlagerungsbewertungen
Given I open an editor "BewertungUmZu2" from table "(Valuation):(Valuation)" with command "VIEW" for search criteria "$,,artikel==FAHRRAD-05;detursache==Manuelle Umbuchung;buart==Zugang;@ablageart=lebendig;@richtung=rückwärts;@maxtreffer=1"
...
Given I open an editor "BewertungUmAb2" from table "(Valuation):(Valuation)" with command "VIEW" for search criteria "$,,artikel==FAHRRAD-05;detursache==Manuelle Umbuchung;buart==Abgang;@ablageart=lebendig;@richtung=rückwärts;@maxtreffer=1"
...
# Bewertung zu Abgang 2
Given I open an editor "BewertungAb3a" from table "(Valuation):(Valuation)" with command "VIEW" for search criteria "$,,artikel==FAHRRAD-05;detursache==Lieferschein Verkauf;mge==7;@ablageart=lebendig;"
Then field "ppsref^id" has value equal to field "id" from editor "JournalAb3"
...
Scenario: Ruecklieferung von MLF01
Given I open an editor "VK-Rueck" from table "(Sales):(PackingSlip)" with command "RETURN" for record from editor "VKLieferschein"
And I set field "ueb" to "ja"
And I modify table
    | !row | mge |
    | 1    | -5  |
...
# Journaleintrag fuer Ruecklieferung
Given I open an editor "Journal-Rueck" from table "(Journal):(Journal)" with command "VIEW" for record "$,,artikel==FAHRRAD-05;detursache==Rücklieferung Verkauf;buarta==Abgang;"
Then field "buarta" has value "Abgang"
Then field "detursache" has value "Rücklieferung Verkauf"
Then field "platz" has value "MLF01"
Then field "mge" has value "-5"
Then field "rueckorig^id" has value equal to field "id" from editor "JournalAb1"
And I close the current editor
...
Given I open an editor "BewertungAb1-Rueck" from table "(Valuation):(Valuation)" with command "VIEW" for search criteria "$,,artikel==FAHRRAD-05;detursache==Rücklieferung Verkauf;@ablageart=lebendig;"
Then field "ppsref^id" has value equal to field "id" from editor "JournalAb1"
...
Given I open an editor "BewertungAb3b" from table "(Valuation):(Valuation)" with command "VIEW" for search criteria "$,,artikel==FAHRRAD-05;detursache==Lieferschein Verkauf;mge==7;@ablageart=lebendig;"
Then field "ppsref^id" has value equal to field "id" from editor "JournalAb3"
