# *****************************************************************************
#  Name             : rueckbuchung_mit_umbuchung_scenario8.feature
#  Autor            : carue
...
# *****************************************************************************
@persistent
Feature: rueckbuchung_mit_umbuchung_scenario8.feature
Background:
...
And I append rows
    ...
    | RAD-08  | 10  | Paar | 10.00 |
And I respond with answer "ja" to the dialog with id "4841"
And I save the current editor

# Nachbewerten + Kostenverbuchung(alles)
Given I create CostEntriesSuggestions "RAD-08" with all types of cost entry for startdate "01.01." until enddate "." with Command Revalue

# Journaleintraege pruefen
Given I open an editor "JournalZu" from table "(Journal):(Journal)" with command "VIEW" for record "$,,artikel==RAD-08;buarta==Zugang;"
...
# Platzmenge pruefen
Given I query StorageQuantity for Product "RAD-08" on StorageLocation "MLF01"
...
# Bewertungen pruefen
Given I open an editor "BewertungZu" from table "(Valuation):(Valuation)" with command "VIEW" for search criteria "$,,artikel=RAD-08;buart==Zugang;"
...
And I append rows
    ...
    | RAD-08  | 10  | Paar |  2.00 | MLF01   | L3F1  |
And I respond with answer "ja" to the dialog with id "4841"
And I save the current editor
...
# Journaleintraege pruefen
Given I open an editor "JournalUmAb1" from table "(Journal):(Journal)" with command "VIEW" for record "$,,artikel==RAD-08;buarta==Abgang;detursache==Umlagerungsrechnung Einkauf;"
...
Given I open an editor "JournalUmZu1" from table "(Journal):(Journal)" with command "VIEW" for record "$,,artikel==RAD-08;buarta==Zugang;detursache==Umlagerungsrechnung Einkauf"
Then field "buarta" has value "Zugang"
Then field "gmge" has value "10"
Then field "mge" has value "20"
...
Given I open an editor "BewertungUmAb1a" from table "(Valuation):(Valuation)" with command "VIEW" for search criteria "$,,artikel=RAD-08;buart==Abgang;detursache==Umlagerungsrechnung Einkauf;@ablageart=lebendig;@richtung=rückwärts;@maxtreffer=1"
...
Given I open an editor "BewertungUmZu1a" from table "(Valuation):(Valuation)" with command "VIEW" for search criteria "$,,artikel=RAD-08;buart==Zugang;detursache==Umlagerungsrechnung Einkauf;@ablageart=lebendig;@richtung=rückwärts;@maxtreffer=1"
...
# Journaleintraege pruefen
Given I open an editor "JournalUmAb2" from table "(Journal):(Journal)" with command "VIEW" for record "$,,artikel==RAD-08;buarta==Abgang;detursache==Umlagerungsrechnung Einkauf;@richtung=rückwärts;@maxtreffer=1"
Then field "buarta" has value "Abgang"
Then field "gmge" has value "10"
Then field "mge" has value "20"
Then field "platz" has value "L3F1"
...
Given I open an editor "JournalUmZu2" from table "(Journal):(Journal)" with command "VIEW" for record "$,,artikel==RAD-08;buarta==Zugang;detursache==Umlagerungsrechnung Einkauf;@richtung=rückwärts;@maxtreffer=1"
Then field "buarta" has value "Zugang"
Then field "gmge" has value "10"
Then field "mge" has value "20"
...
Given I query StorageQuantity for Product "RAD-08" on StorageLocation "L2F1"
Then StorageQuantities have values
    | gebmge | gebeinh | lj^id            | orig^id       | bewmge | bewlj^id         | beworig^id    |
...
# Umlagerungsbewertungen pruefen - wichtig sind die additiven Kosten
Given I open an editor "BewertungUmAb2a" from table "(Valuation):(Valuation)" with command "VIEW" for search criteria "$,,artikel=RAD-08;buart==Abgang;detursache==Umlagerungsrechnung Einkauf;@ablageart=lebendig;@richtung=rückwärts;@maxtreffer=1"
Then field "buart" has value "Abgang"
Then field "detursache" has value "Umlagerungsrechnung Einkauf"
...
Given I open an editor "BewertungUmZu2a" from table "(Valuation):(Valuation)" with command "VIEW" for search criteria "$,,artikel=RAD-08;buart==Zugang;detursache==Umlagerungsrechnung Einkauf;@ablageart=lebendig;@richtung=rückwärts;@maxtreffer=1"
Then field "buart" has value "Zugang"
Then field "detursache" has value "Umlagerungsrechnung Einkauf"
...
And I set field "nummer" to "8rueck"
...
# Journaleintraege pruefen
Given I open an editor "JournalRueck" from table "(Journal):(Journal)" with command "VIEW" for record "$,,artikel==RAD-08;buarta==Zugang;detursache==Rücklieferung Einkauf;"
Then field "buarta" has value "Zugang"
Then field "gmge" has value "-10"
...
# Bewertungen pruefen
Given I open an editor "BewertungRueck" from table "(Valuation):(Valuation)" with command "VIEW" for search criteria "$,,artikel=RAD-08;buart==Zugang;detursache==Rücklieferung Einkauf;@ablageart=lebendig;@richtung=rückwärts;@maxtreffer=1"
Then field "ppsrefid" has value equal to field "id" from editor "JournalZu"
...
And I set field "nummer" to "8storno"
And I save the current editor
...
# Journaleintraege pruefen
Given I open an editor "JournalStorno" from table "(Journal):(Journal)" with command "VIEW" for record "$,,artikel==RAD-08;buarta==Zugang;detursache==Storno-Rücklieferung Einkauf;"
Then field "buarta" has value "Zugang"
Then field "gmge" has value "10"
Then field "mge" has value "20"
...
# Bewertungen pruefen
Given I open an editor "BewertungStorno" from table "(Valuation):(Valuation)" with command "VIEW" for search criteria "$,,artikel=RAD-08;buart==Zugang;detursache==Storno-Rücklieferung Einkauf;@ablageart=lebendig;@richtung=rückwärts;@maxtreffer=1"
Then field "ppsrefid" has value equal to field "id" from editor "JournalZu"
