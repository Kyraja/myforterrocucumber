# *****************************************************************************
#  Name             : rueckbuchung_mit_umbuchung_scenario2.feature
#  Autor            : carue
...
# *****************************************************************************
@persistent
Feature: rueckbuchung_mit_umbuchung_scenario2.feature
Background:
Given I set the fake date to "12.01.95"

Scenario: 01 Bestaende fuer Bauteile auf 0 setzen, Fertigteil kopieren
And I set StorageQuantity to zero for Product "RAHMEN" on StorageLocation "MLF01" with document "Scenario2"
And I set StorageQuantity to zero for Product "RAD" on StorageLocation "MLF01" with document "Scenario2"
And I set StorageQuantity to zero for Product "SATTEL" on StorageLocation "MLF01" with document "Scenario2"
And I set StorageQuantity to zero for Product "PEDALE" on StorageLocation "MLF01" with document "Scenario2"

# Fertigteil FAHRRAD kopieren
Given I open an editor "Fahrrad" from table "(Part):(Product)" with command "COPY" for record "FAHRRAD"
And I set field "such" to "FAHRRAD-02"
And I save the current editor

# 02 Verkaufsauftrag fuer Fahrrad anlegen und Bedarfe einkaufen
Given I create a SalesOrder "Auftrag" for Customer "RADSHOP" with Product "FAHRRAD-02" and quantity "10"
...
Given I open an editor "Rueckmeldung1" from table "(Workorder):(WorkOrders)" with command "DONE" for record "RAD02_000"
...
Given I open StockMovementJournal "Journal1" for Product "FAHRRAD-02" and cause of entry "Rückmeldung Fertigung" and transaction "Rueckmeldung1" with command "VIEW"
Then field "buarta" has value "Zugang"
Then field "mge" has value "5"
And I close the current editor

# Platzmenge pruefen
Given I query StorageQuantity for Product "FAHRRAD-02" on StorageLocation "MLF01"
...
# Bewertung pruefen
Given I open latest Valuation "Bewertung1" for Product "FAHRRAD-02" and valuation transaction "Journal1" with command "VIEW"
...
And I transfer StorageQuantity of "5" for Product "FAHRRAD-02" from StorageLocation "MLF01" to "ABLA" with document "Umlagern2"

# Zugangsjournal der Umlagerung
Given I open an editor "JournalUmZu" from table "(Journal):(Journal)" with command "VIEW" for record "$,,artikel==FAHRRAD-02;detursache==Manuelle Umbuchung;buarta==Zugang"
Then field "buarta" has value "Zugang"
...
Given I query StorageQuantity for Product "FAHRRAD-02" on StorageLocation "ABLA"
Then StorageQuantities have values
    | gebmge | lj^id           | orig^id      | bewmge | bewlj^id        | beworig^id   |
...
# Bewertungen pruefen
Given I open latest Valuation "BewertungUmZu1" for Product "FAHRRAD-02" and valuation transaction "JournalUmZu" with command "VIEW"
...
Given I open latest Valuation "BewertungUmAb1" for Product "FAHRRAD-02" and valuation transaction "JournalUmAb" with command "VIEW"
...
Given I open an editor "Rueckbau1" from table "(Workorder):(WorkOrders)" with command "RETURN" for record "RAD02_000"
And I set field "mgr" to "101"
...
Given I open StockMovementJournal "JournalRueck1" for Product "FAHRRAD-02" and cause of entry "Rückbau Fertigung" and transaction "Rueckbau1" with command "VIEW"
Then field "buarta" has value "Zugang"
Then field "platz" has value "MLF01"
Then field "mge" has value "-5"
...
# Bewertungen pruefen
Given I open latest Valuation "BewertungRueck1" for Product "FAHRRAD-02" and valuation transaction "Journal1" with command "VIEW"
Then field "ppsref^id" has value equal to field "id" from editor "Journal1"
...
Given I open latest Valuation "BewertungUmAb2" for Product "FAHRRAD-02" and valuation transaction "JournalUmAb" with command "VIEW"
Then field "buart" has value "Abgang"
Then field "detursache" has value "Manuelle Umbuchung"
...
Given I open latest Valuation "BewertungUmZu2" for Product "FAHRRAD-02" and valuation transaction "JournalUmZu" with command "VIEW"
Then field "buart" has value "Zugang"
Then field "detursache" has value "Manuelle Umbuchung"
...
# 07 Artikel erneut fertigen
Given I open an editor "Rueckmeldung2" from table "(Workorder):(WorkOrders)" with command "DONE" for record "RAD02_000"
And I set field "mgr" to "101"
And I set field "sofort" to "1"
And I set field "gutmge" to "5" in row 1
...
Given I open StockMovementJournal "Journal2" for Product "FAHRRAD-02" and cause of entry "Rückmeldung Fertigung" and transaction "Rueckmeldung2" with command "VIEW"
Then field "buarta" has value "Zugang"
...
# Bewertung pruefen
Given I open latest Valuation "Bewertung2" for Product "FAHRRAD-02" and valuation transaction "Journal2" with command "VIEW"
...
# Umlagerungsbewertungen pruefen
Given I open latest Valuation "BewertungUmZu3" for Product "FAHRRAD-02" and valuation transaction "JournalUmZu" with command "VIEW"
Then field "buart" has value "Zugang"
Then field "detursache" has value "Manuelle Umbuchung"
...
Given I open latest Valuation "BewertungUmAb3" for Product "FAHRRAD-02" and valuation transaction "JournalUmAb" with command "VIEW"
Then field "buart" has value "Abgang"
Then field "detursache" has value "Manuelle Umbuchung"
...
# Journaleintrag pruefen
Given I open an editor "Journal3" from table "(Journal):(Journal)" with command "VIEW" for record "$,,artikel==FAHRRAD-02;detursache==Lieferschein Verkauf;"
Then field "buarta" has value "Abgang"
...
# Bewertung pruefen
Given I open latest Valuation "Bewertung2" for Product "FAHRRAD-02" and valuation transaction "Journal3" with command "VIEW"
Then field "ppsref^id" has value equal to field "id" from editor "Journal3"
Then table has values
    | tmge | orig^id      | beworig^id   |
    | 5    | !Journal2^id | !Journal2^id |
And I close the current editor
