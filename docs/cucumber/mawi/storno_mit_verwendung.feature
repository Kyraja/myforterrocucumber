# *****************************************************************************
#  Name             : storno_mit_verwendung.feature
#  Autor            : carue
#  Verantwortlich   : carue
#  Kontrolle        : ak
#  Funktion         : Storno mit scharfer, unscharfer Verwednung und Jokerbestand
#
# *****************************************************************************
@persistent
Feature: storno_mit_verwendung.feature
Background:
...
# Storno zu Betriebsauftrag
Scenario: 03c Storno der Rueckmeldung - Material wird mit wie in 3b zurueckgelegt
Given I open an editor "Storno01" via ID from editor "Rueckmeldung01" from field "id" in row 0 for table "(Workorder):(CompletionConfirmations)" with command "REVERSAL" 
And I save the current editor
...
Then table has values
    | art       | zmge | amge | rueckmge | restmge | storniert | verw   | verwla  |
    | BAUGRUPPE | -55  |      | -55      | 0       | nein      | 1111_1 | 1111_1  |
    | EINKAUF-1 |      | -60  | -60      | 0       | nein      | 1111_1 | 1111_1  |
    | EINKAUF-1 |      | -40  | -40      | 0       | nein      | 1111_1 | 1111    |
    | EINKAUF-1 |      | -10  | -10      | 0       | nein      | 1111_1 |         |
    | EINKAUF-2 |      | -30  | -30      | 0       | nein      | 1111_1 | 1111_1  |
    | EINKAUF-2 |      | -20  | -20      | 0       | nein      | 1111_1 | 1111    |
    | EINKAUF-2 |      | -5   | -5       | 0       | nein      | 1111_1 |         |
    | BAUGRUPPE | 55   |      | 55       | 0       | ja        | 1111_1 | 1111_1  |
    | EINKAUF-1 |      | 10   | 10       | 0       | ja        | 1111_1 |         |
    | EINKAUF-1 |      | 40   | 40       | 0       | ja        | 1111_1 | 1111    |
    | EINKAUF-1 |      | 60   | 60       | 0       | ja        | 1111_1 | 1111_1  |
    | EINKAUF-2 |      | 5    | 5        | 0       | ja        | 1111_1 |         |
    | EINKAUF-2 |      | 20   | 20       | 0       | ja        | 1111_1 | 1111    |
    | EINKAUF-2 |      | 30   | 30       | 0       | ja        | 1111_1 | 1111_1  |
And I close the current editor
...
Then field "vorgang^id" has value equal to field "id" from editor "Storno01"
And I close the current editor

And I open an editor "LJ_Baugruppe_Orig" via ID from editor "LJ_Baugruppe1" from field "stornolj" in row 0 for table "(Journal):(Journal)" with command "VIEW"
Then fields have values
    | mge       | 55 |
    | rueckmge  | 55 |
    | restmge   | 0  |
...
Scenario: 07 Lieferschein wieder stornieren - Buchung aus 06 wird zurueckgedreht
Given I open an editor "StornoLS" from table "(Sales):(PackingSlip)" with command "REVERSAL" for record from editor "Lieferschein"
And I save the current editor
...
And I set fields
    | adatum    | . |
And I set field "beleg" to "nummer" from editor "StornoLS"
And I press start
Then table has values
    | art       | amge  | verw   | verwla |
    | BAUGRUPPE | -30   | 1111_1 | 1111_1 |
