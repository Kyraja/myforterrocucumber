# *****************************************************************************
#  Name             : rueckbuchung_folgeplatz_scenario07.feature
#  Autor            : carue
...
# *****************************************************************************
@persistent
Feature: rueckbuchung_folgeplatz_scenario07.feature
Background:
...
And I append rows
    ...
    | RAD-07  | 100 | Paar | 10.00 | WELA  |
And I respond with answer "ja" to the dialog with id "4841"
And I save the current editor


# Journaleintraege
Given I open an editor "JournalZu1" from table "(Journal):(Journal)" with command "VIEW" for record "$,,artikel==RAD-07;buarta==Zugang;platz==WELA;"
...
# Platzmengen
Given I query "gebmge,gebeinh,lj^id,orig^id,verfdat,bewmge,bewlj^id,beworig^id,bewdat" from StorageQuantity for Product "RAD-07" on StorageLocation "WELA"
...
# Bewertung
Given I open latest Valuation "BewertungZu1-1" for Product "RAD-07" and valuation transaction "JournalZu1" with command "VIEW"
...
And I append rows
    ...
    | RAD-07  | 100 | Paar |  2.00 | WELA    | L3F1  |
And I respond with answer "ja" to the dialog with id "4841"
And I save the current editor


# Journaleintraege
Given I open an editor "JournalUmAb1" from table "(Journal):(Journal)" with command "VIEW" for record "$,,artikel==RAD-07;buarta==Abgang;detursache==Umlagerungsrechnung Einkauf;platz==WELA;budat==13.1.95;"
...
Given I open an editor "JournalUmZu1" from table "(Journal):(Journal)" with command "VIEW" for record "$,,artikel==RAD-07;buarta==Zugang;detursache==Umlagerungsrechnung Einkauf;platz==L3F1;budat==13.1.95;"
Then field "detursache" has value "Umlagerungsrechnung Einkauf"
Then field "buarta" has value "Zugang"
...
# Platzmengen
Given I query StorageQuantity for Product "RAD-07" on StorageLocation "WELA"
Then StorageQuantity is zero

Given I query "gebmge,gebeinh,lj^id,orig^id,verfdat,bewmge,bewlj^id,beworig^id,bewdat" from StorageQuantity for Product "RAD-07" on StorageLocation "L3F1"
Then StorageQuantities have values
    | gebmge | gebeinh | lj^id            | orig^id        | verfdat    | bewmge | bewlj^id         | beworig^id     | bewdat     |
...
# Bewertungen
Given I open latest Valuation "BewertungUmAb1-1" for Product "RAD-07" and valuation transaction "JournalUmAb1" with command "VIEW"
...
Given I open latest Valuation "BewertungUmZu1-1" for Product "RAD-07" and valuation transaction "JournalUmZu1" with command "VIEW"
...
Scenario: 04 Teil-Ruecklieferung des Zugangs
...
Given I open an editor "JournalRueck1" from table "(Journal):(Journal)" with command "VIEW" for record "$,,artikel==RAD-07;buarta==Zugang;platz==L3F1;detursache==Rücklieferung Einkauf;"
Then field "buarta" has value "Zugang"
Then field "platz" has value "L3F1"
...
Then table has values
    | mge | lj^id          | orig^id        | verfdat    | bewmge | bewlj^id       | beworig^id     | bewdat     |
    | 30  | !JournalZu1^id | !JournalZu1^id | 12.01.1995 | 30     | !JournalZu1^id | !JournalZu1^id | 12.01.1995 |
And I close the current editor
...
Given I open an editor "JournalUmAbBmk1" from table "(Journal):(Journal)" with command "VIEW" for record "$,,artikel==RAD-07;buarta==Abgang;detursache==Bewertungsmengenkorrektur Umlagerungsrechnung Einkauf;platz==WELA;budat==14.1.95;"
...
Given I open an editor "JournalUmZuBmk1" from table "(Journal):(Journal)" with command "VIEW" for record "$,,artikel==RAD-07;buarta==Zugang;detursache==Bewertungsmengenkorrektur Umlagerungsrechnung Einkauf;platz==L3F1;budat==14.1.95;"
Then field "detursache" has value "Bewertungsmengenkorrektur Umlagerungsrechnung Einkauf"
Then field "buarta" has value "Zugang"
Then field "platz" has value "L3F1"
Then field "rueckgmge" has value "-85"
...
Then StorageQuantities have values
    | gebmge | gebeinh | lj^id            | orig^id        | verfdat    | bewmge | bewlj^id         | beworig^id     | bewdat     |
    | 30     | Stück  | !JournalUmZu1^id | !JournalZu1^id | 12.01.1995 | 30     | !JournalUmZu1^id | !JournalZu1^id | 12.01.1995 |


# Bewertungen
Given I open latest Valuation "BewertungZu1-2" for Product "RAD-07" and valuation transaction "JournalZu1" with command "VIEW"
Then field "ppsrefid" has value equal to field "id" from editor "JournalZu1"
...
Given I open latest Valuation "BewertungUmAb1-2" for Product "RAD-07" and valuation transaction "JournalUmAb1" with command "VIEW"
Then field "ppsrefid" has value equal to field "id" from editor "JournalUmAb1"
...
Given I open latest Valuation "BewertungUmZu1-2" for Product "RAD-07" and valuation transaction "JournalUmZu1" with command "VIEW"
Then field "ppsrefid" has value equal to field "id" from editor "JournalUmZu1"
...
Then table has values
    | tmge | orig^id        | beworig^id     | tbewpr  | addkosten |
    | 30   | !JournalZu1^id | !JournalZu1^id | 11.6667 | 6.6667    |
And I close the current editor

# ------------------------------------------------------------------------------------------------------------------------ #

Scenario: 05 Abgang von L3F1 fuer Artikel RAD-07
...
And I append rows
    | artikel | mge | he   | preis | platz |
    | RAD-07  | 50  | Paar | 20.00 | L3F1  |
And I save the current editor


# Journaleintrag Abgang
Given I open an editor "JournalAb1" from table "(Journal):(Journal)" with command "VIEW" for record "$,,artikel==RAD-07;buarta==Abgang;detursache==Lieferschein Verkauf;platz==L3F1;budat==16.1.95;"
...
Then table has values
    | mge | lj^id            | orig^id        | verfdat    | bewmge | bewlj^id         | beworig^id     | bewdat     |
    | 30  | !JournalUmZu1^id | !JournalZu1^id | 12.01.1995 | 30     | !JournalUmZu1^id | !JournalZu1^id | 12.01.1995 |
And I close the current editor
...
Then StorageQuantities have values
    | gebmge | gebeinh | lj^id          | orig^id | verfdat    | bewmge | bewlj^id       | beworig^id | bewdat     |
    | -70    | Stück  | !JournalAb1^id | (0,0,0) | 16.01.1995 | -70    | !JournalAb1^id | (0,0,0)    | 16.01.1995 |


# Bewertung
Given I open latest Valuation "BewertungAb1-1" for Product "RAD-07" and valuation transaction "JournalAb1" with command "VIEW"
Then field "ppsrefid" has value equal to field "id" from editor "JournalAb1"
Then field "vorgaenger" is empty
Then field "nachfolger" is empty
Then table has values
    | tmge | orig^id        | beworig^id     | tbewpr  | addkosten |
    | 30   | !JournalZu1^id | !JournalZu1^id | 11.6667 | 0.0000    |
    | 70   | (0,0,0)        | (0,0,0)        | 6.0000  | 0.0000    |
And I close the current editor
...
Given I open an editor "JournalStorno1" from table "(Journal):(Journal)" with command "VIEW" for record "$,,artikel==RAD-07;buarta==Zugang;platz==L3F1;detursache==Storno-Rücklieferung Einkauf;"
...
Given I open an editor "JournalUmAbSBmk1" from table "(Journal):(Journal)" with command "VIEW" for record "$,,artikel==RAD-07;buarta==Abgang;detursache==Storno-Bewertungsmengenkorrektur Umlagerungsrechnung Ek;platz==WELA;budat==20.1.95;"
...
Given I open an editor "JournalUmZuSBmk1" from table "(Journal):(Journal)" with command "VIEW" for record "$,,artikel==RAD-07;buarta==Zugang;detursache==Storno-Bewertungsmengenkorrektur Umlagerungsrechnung Ek;platz==L3F1;budat==20.1.95;"
Then field "detursache" has value "Storno-Bewertungsmengenkorrektur Umlagerungsrechnung Ek"
Then field "gmge" has value "85"
Then field "mge" has value "170"
...
# Bewertungen
Given I open latest Valuation "BewertungZu1-3" for Product "RAD-07" and valuation transaction "JournalZu1" with command "VIEW"
Then field "ppsrefid" has value equal to field "id" from editor "JournalZu1"
...
Given I open latest Valuation "BewertungUmAb1-3" for Product "RAD-07" and valuation transaction "JournalUmAb1" with command "VIEW"
Then field "ppsrefid" has value equal to field "id" from editor "JournalUmAb1"
...
Given I open latest Valuation "BewertungUmZu1-3" for Product "RAD-07" and valuation transaction "JournalUmZu1" with command "VIEW"
Then field "ppsrefid" has value equal to field "id" from editor "JournalUmZu1"
...
# Nachbewerten, damit Abgangsbewertung angepasst wird
And I run Revaluation

# Abgangsbewertung
Given I open latest Valuation "BewertungAb1-2" for Product "RAD-07" and valuation transaction "JournalAb1" with command "VIEW"
Then field "ppsrefid" has value equal to field "id" from editor "JournalAb1"
Then field "vorgaenger" is not empty
Then field "nachfolger" is empty
Then table has values
