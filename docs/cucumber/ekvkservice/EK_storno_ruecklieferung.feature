...
And I set field "dispoa" to "bedarfsbezogen"
And I set field "lief" to "1"
And I set field "bstnr" to "1234567890abcdefghijklmnopqrstuvwxy"
...
Then field "bstnr" has value "1234567890abcdefghijklmnopqrstuvwxy" in row 1
And I save the current editor
...
And I set field "num2" to "114-FALL-EK"
...
And  I open an editor "Umlagern114" from table "(Purchasing):(PackingSlip)" with command "NEW" for record ""
And I set field "lief" to "LOHNFERT"
...
And  I open an editor "Umlagern115" from table "(Purchasing):(PackingSlip)" with command "NEW" for record ""
...
# Umlagerung
And  I open an editor "Umlagern116" from table "(Purchasing):(PackingSlip)" with command "NEW" for record ""
And I set field "bsart" to "Umlagern"
And I set field "lief" to "1"
...
And I set field "beleg" to id from editor "lieferschein-117"
...
And I set field "name" to "Verpackungskosten"
And I save the current editor
...
And I set field "vorganga" to "(Downpayment)"
And I set field "beleg" to id from editor "bestellung-235"
And I set field "num4" to "235-AR2"
And I set field "vom" to "."
And I set field "ueb" to "ja"
And I set field "pwert" to "1000" in row 1
And I set field "kenn" to "FALL-235BIS"
And I respond with answer "Ja" to the dialog with id "4841"
And I save the current editor

# Ausgabe Rechnung
Given I open an editor "rechnung-view" from table "(Purchasing):(Invoice)" with command "VIEW" for record "+235-AR2"
And I close the current editor
...
# Storno Anzahlung nicht möglich, weil bereits bezahlt
...
@FALL-316
Scenario: FALL-316
# Rücklieferung EK Umlagerungen von Hongkong nach Karlsruhe
...
@FALL-317
Scenario:  FALL-317
# Rücklieferung EK Lieferschein mit Materialzuordnung
...
# Steuerregel mit zmart = "Ware" (Art der zusammenfassenden Meldung)
Given  I open an editor "tax rule 2" from table "(TaxCode):(TaxRule)" with command "COPY" for record "EKINREGEL"
And  I set field "such" to "EKINREGELA"
And  I set field "namebspr" to "Einkauf Inland steuerpflichtig Regelsteuersatz (Test)"
And  I set field "ev" to "Einkauf"
And  I set field "zmart" to "Ware"
And  I save the current editor

# Vorgangssteuerregel EK
Given I open an editor "process tax rule" from table "(ProcessTaxRule):(ProcessTaxRule)" with command "STORE" for record "EKIN-DE"
And I set field "such" to "EKIN-DE"
And I set field "stlaart" to "Inland"
And I set field "namebspr" to "Einkauf Inland Deutschland nur steuerpflichtig"
And I set field "ev" to "Einkauf"
# nur steuerpflichtig
...
And I set field "bestlaart" to "Inland" in row !lastRow
And I set field "vrgstrgl" to "EKIN-DE" in row !lastRow
And  I save the current editor

# Kontosteuerregel
Given  I open an editor "account tax rule 1" from table "(TaxCode):(AccountTaxRule)" with command "STORE" for record "EKIN-ALL"
And  I create a new row at the end of the table
And  I set field "vrgstrgl" to "EKIN-DE" in row !lastRow
And  I set field "strgl" to "EKINREGELA" in row !lastRow
And  I save the current editor
...
Given I open an editor "warengruppe" from table "(Company):(MaterialGroup)" with command "COPY" for record "55"
And I set field "nummer" to "4111FALL"
And I set field "such" to "FALL-4111"
And I set field "bestausekso" to "FALL-411"
...
# Artikel anlegen: nicht bestandsgefuehrt
Given I open an editor "artikel" from table "(Part):(Product)" with command "STORE" for record "4111-FALL"
And I set field "num2" to "4111FALL"
And I set field "such" to "FALL-4111"
And I set field "namebspr" to "FALL-4111"
And I set field "bsart" to "Fremdbeschaffung"
And I set field "dispoa" to "bedarfsbezogen"
And I set field "lief" to "1"
And I set field "wgruppe" to "FALL-4111"
And I set field "erlgrp" to "66"
And I set field "ekbewverf" to "6"
And I save the current editor
...
And I create a new row at the end of the table
And I set field "artex" to "FALL-4111" in row 2
And I set field "mge" to "4111" in row 2
And I set field "preis" to "4111" in row 2
# zusatzposition um das Feld "kstelle" testen zu koennen
# And I set field "artex" to "VERP-234" in row 2
# And I set field "pwert" to "411" in row 2
# Then field "kstelle" has value "101" in row 2
...
And I set field "mge" to "411" in row 1
And I set field "preis" to "411" in row 1
# Steuerregelrelevante Felder werden spaeter in die kaufm. Gutschrift uebernohmen
And I set field "vrgstrgl" to "EKIN-DE"
And I set field "skfaehig" to "nein" in row 1
Then field "strgl" has value "EKINREGELA" in row 1
Then field "zstrgl" has value "EKINREGELA-3" in row 1
# Steuerregel fixieren
And I set field "fixstrgl" to "ja" in row 1
# zmart = "Ware"
Then field "zmart" has value "Ware" in row 1
# hier wird ein Spezialkonto sg. Zwischenkonto manuell eingetragen
And I set field "konto" to "0361FALL" in row 1
# Kostenstelle aendern, um zu pruefen, ob diese Aenderung in der KGS ankommt
And I set field "mge" to "411" in row 2
And I set field "preis" to "4110" in row 2
And I set field "kstelle" to "234-KV" in row 2
And I set field "kenn" to "FALL-411"
And I respond with answer "Ja" to the dialog with id "4841"
And I save the current editor
...
# Rücklieferschein anlegen
Given I open an editor "rls-411" from table "(Purchasing):(PackingSlip)" with command "RETURN" for record from editor "lieferschein-view"
...
And I set field "vom" to "."
And I set field "kenn" to "FALL-411"
# Die ermittelte Vorgangssteuerregel passt nicht zu der aus der Rechnung
# Es werden die initalisierten Werte der Kaufm. Gutschrift beibehalten
Then field "zstrgl" has value "EKINREGEL-3" in row 1
Then field "zmart" is empty in row 1
Then field "skfaehig" has value "nein" in row 1
Then field "konto" has value "36301" in row 1
Then field "vorgangskonto" has value "0411FALL" in row 1
Then field "fixvorgangskonto" has value "nein" in row 1
Then field "strgl" has value "EKINREGEL" in row 1
Then field "proz" has value "0" in row 1
# Wegen Steuerregelpruefung
And I set field "strgl" to "EKINREGEL" in row 1
...
Then field "skfaehig" is not modifiable in row 1
And I respond with answer "Ja" to the dialog with id "4841"
And I save the current editor
...
# Lieferant 1 Vorgangsteuerregel zuruecksetzen
Given I open an editor "lieferant" from table "(Vendor):(Vendor)" with command "STORE" for record "1"
...
And I set field "vom" to "."
And I set field "kenn" to "FALL-415"
And I set field "mge" to "410" in row 1
And I set field "preis" to "415" in row 1
And I respond with answer "Ja" to the dialog with id "4841"
And I save the current editor
...
Then field "lehe" is modifiable in row 1
...
And I set field "ueb" to "ja"
And I set field "vom" to "."
# Ueberberechnung nicht moeglich
And I set field "mge" to "149" in row 1
...
And I set field "such" to "FALL-801"
# And I create a new row at the end of the table
And I set field "vorgang" to "$,,artikel=Fall-801;platz=f1;@datenbank=40;@gruppe=4;" in row 1
...
And I set field "such" to "FALL-802"
# And I create a new row at the end of the table
And I set field "vorgang" to "$,,artikel=Fall-802;platz=f1;@datenbank=40;@gruppe=4;" in row 1
And I set field "ntbewpr" to "500,1234" in row 1
And I save the current editor
...
And I set field "such" to "FALL-803"
# And I create a new row at the end of the table
And I set field "vorgang" to "$,,artikel=Fall-803;platz=f1;@datenbank=40;@gruppe=4;" in row 1
And I set field "ntbewpr" to "500,1234" in row 1
And I save the current editor
...
And I set field "such" to "FALL-804"
# And I create a new row at the end of the table
And I set field "vorgang" to "$,,artikel=Fall-804;platz=f1;@datenbank=40;@gruppe=4;" in row 1
And I set field "ntbewpr" to "500,1234" in row 1
And I save the current editor
...
And I set field "such" to "FALL-805"
# And I create a new row at the end of the table
And I set field "vorgang" to "$,,artikel=Fall-805;platz=f1;@datenbank=40;@gruppe=4;" in row 1
And I set field "ntbewpr" to "500,1234" in row 1
And I save the current editor
...
And I set field "such" to "FALL-806"
# And I create a new row at the end of the table
And I set field "vorgang" to "$,,artikel=Fall-806;platz=f1;@datenbank=40;@gruppe=4;" in row 1
And I set field "ntbewpr" to "500,1234" in row 1
And I save the current editor
...
And I set field "such" to "FALL-807"
# And I create a new row at the end of the table
And I set field "vorgang" to "$,,artikel=Fall-807;platz=f1;@datenbank=40;@gruppe=4;" in row 1
And I set field "ntbewpr" to "500,1234" in row 1
And I save the current editor
...
And I set field "such" to "FALL-808"
# And I create a new row at the end of the table
And I set field "vorgang" to "$,,artikel=Fall-808;platz=f1;@datenbank=40;@gruppe=4;" in row 1
And I set field "ntbewpr" to "500,1234" in row 1
And I save the current editor
...
And I set field "such" to "FALL-809"
# And I create a new row at the end of the table
And I set field "vorgang" to "$,,artikel=Fall-809;platz=f1;@datenbank=40;@gruppe=4;" in row 1
And I set field "ntbewpr" to "500,1234" in row 1
And I save the current editor
...
And I set field "such" to "FALL-810"
# And I create a new row at the end of the table
And I set field "vorgang" to "$,,artikel=Fall-810;platz=f1;@datenbank=40;@gruppe=4;" in row 1
And I set field "ntbewpr" to "500,1234" in row 1
And I save the current editor
...
# FIXME RE nachher preis muss da und geschǬtzt sein
...
@FALL-813
@persistent
Scenario: FALL-813 Bestellung bleibt in der Ablage nach Storno der Ueberlieferung

# Konto 813-FALL mit Steuerregel
Given I open an editor "konto" from table "(Account):(Account)" with command "COPY" for record "10000"
And I set field "nummer" to "0813FALL"
And I set field "such" to "FALL-813"
And I set field "ktostrgl" to "EKIN-ALL"
And I save the current editor
...
And I set field "nummer" to "0813FALL"
And I set field "such" to "FALL-813"
And I set field "bestausekso" to "FALL-813"
And I save the current editor

# Artikel anlegen
Given I open an editor "artikel" from table "(Part):(Product)" with command "STORE" for record "813-FALL"
And I set field "num2" to "813-FALL"
And I set field "such" to "FALL-813"
And I set field "namebspr" to "FALL-813"
And I set field "bsart" to "Fremdbeschaffung"
And I set field "dispoa" to "bedarfsbezogen"
And I set field "lief" to "1"
And I set field "wgruppe" to "FALL-813"
And I set field "erlgrp" to "66"
And I set field "ekbewverf" to "6"
And I set field "wgruppe" to "FALL-813"
And I save the current editor
...
# Bestellung anlegen
Given I open an editor "bestellung-813" from table "(Purchasing):(PurchaseOrder)" with command "NEW" for record ""
And I set fields
    | lief   | 1      |
    | num4   | 813-BE |
And I append rows
...
# 1. Lieferschein aus Bestellung mit Restmengenstorno erzeugen
Given I open an editor "lieferschein1-813" from table "(Purchasing):(PackingSlip)" with command "NEW" for record ""
And I set field "beleg" to id from editor "bestellung-813"
And I set field "num4" to "813-LS1"
And I set field "ebeleg" to "Lieferschein1-813"
And I set field "vom" to "."
And I set field "ueb" to "ja"
...
# 2. Lieferschein aus Bestellung mit Ueberlieferung erzeugen
Given I open an editor "lieferschein2-813" from table "(Purchasing):(PackingSlip)" with command "NEW" for record ""
And I set field "beleg" to id from editor "bestellung-813"
And I set field "num4" to "813-LS2"
And I set field "ebeleg" to "Lieferschein2_813"
And I set field "vom" to "."
And I set field "ueb" to "ja"
And I set field "mge" to "1" in row 1
And I save the current editor
...
Given I open an editor "stornols" from table "(Purchasing):(PackingSlip)" with command "REVERSAL" for record from editor "lieferschein2-813"
And I set field "num4" to "813-SLS"
And I save the current editor

# Bestellung ist in der Ablage
Given I open an editor "bestellung-813P" from table "(Purchasing):(PurchaseOrder)" with command "VIEW" for record from editor "bestellung-813"
Then field "ablagef" has value "ja"
Then field "ablagef" has value "ja" in row 1
And I close the current editor
...
@FALL-814
@persistent
Scenario: FALL-814 Bestellung kommt aus der Ablage nach Storno des Lieferschein mit Ueberlieferung

# Konto 814-FALL mit Steuerregel
Given I open an editor "konto" from table "(Account):(Account)" with command "COPY" for record "10000"
And I set field "nummer" to "0814FALL"
And I set field "such" to "FALL-814"
And I set field "ktostrgl" to "EKIN-ALL"
And I save the current editor
...
And I set field "nummer" to "0814FALL"
And I set field "such" to "FALL-814"
And I set field "bestausekso" to "FALL-814"
And I save the current editor

# Artikel anlegen
Given I open an editor "artikel" from table "(Part):(Product)" with command "STORE" for record "814-FALL"
And I set field "num2" to "814-FALL"
And I set field "such" to "FALL-814"
And I set field "namebspr" to "FALL-814"
And I set field "bsart" to "Fremdbeschaffung"
And I set field "dispoa" to "bedarfsbezogen"
And I set field "lief" to "1"
And I set field "wgruppe" to "FALL-814"
And I set field "erlgrp" to "66"
And I set field "ekbewverf" to "6"
And I set field "wgruppe" to "FALL-814"
And I save the current editor
...
# Bestellung anlegen
Given I open an editor "bestellung-814" from table "(Purchasing):(PurchaseOrder)" with command "NEW" for record ""
And I set fields
    | lief   | 1      |
    | num4   | 814-BE |
And I append rows
...
# 1. Lieferschein aus Bestellung erzeugen
Given I open an editor "lieferschein1-814" from table "(Purchasing):(PackingSlip)" with command "NEW" for record ""
And I set field "beleg" to id from editor "bestellung-814"
And I set field "num4" to "814-LS1"
And I set field "ebeleg" to "Lieferschein1-814"
And I set field "vom" to "."
And I set field "ueb" to "ja"
...
# 2. Lieferschein aus Bestellung mit Ueberlieferung erzeugen
Given I open an editor "lieferschein2-814" from table "(Purchasing):(PackingSlip)" with command "NEW" for record ""
And I set field "beleg" to id from editor "bestellung-814"
And I set field "num4" to "814-LS2"
And I set field "ebeleg" to "Lieferschein2-814"
And I set field "vom" to "."
And I set field "ueb" to "ja"
And I set field "mge" to "1" in row 1
And I save the current editor
...
# 2. Lieferschein stornieren
Given I open an editor "stornols" from table "(Purchasing):(PackingSlip)" with command "REVERSAL" for record from editor "lieferschein2-814"
And I set field "num4" to "814-SLS"
And I save the current editor

# Bestellung ist wieder lebendig
Given I open an editor "bestellung-814P" from table "(Purchasing):(PurchaseOrder)" with command "VIEW" for record from editor "bestellung-814"
Then field "ablagef" has value "nein"
Then field "ablagef" has value "nein" in row 1
And I close the current editor
...
@FALL-815
@persistent
Scenario: FALL-815 Bestellung kommt aus der Ablage nach Storno des Lieferschein vor Restmengenstornos

# Konto 815-FALL mit Steuerregel
Given I open an editor "konto" from table "(Account):(Account)" with command "COPY" for record "10000"
And I set field "nummer" to "0815FALL"
And I set field "such" to "FALL-815"
And I set field "ktostrgl" to "EKIN-ALL"
And I save the current editor
...
And I set field "nummer" to "0815FALL"
And I set field "such" to "FALL-815"
And I set field "bestausekso" to "FALL-815"
And I save the current editor

# Artikel anlegen
Given I open an editor "artikel" from table "(Part):(Product)" with command "STORE" for record "815-FALL"
And I set field "num2" to "815-FALL"
And I set field "such" to "FALL-815"
And I set field "namebspr" to "FALL-815"
And I set field "bsart" to "Fremdbeschaffung"
And I set field "dispoa" to "bedarfsbezogen"
And I set field "lief" to "1"
And I set field "wgruppe" to "FALL-815"
And I set field "erlgrp" to "66"
And I set field "ekbewverf" to "6"
And I set field "wgruppe" to "FALL-815"
And I save the current editor
...
# Bestellung anlegen
Given I open an editor "bestellung-815" from table "(Purchasing):(PurchaseOrder)" with command "NEW" for record ""
And I set fields
    | lief   | 1      |
    | num4   | 815-BE |
And I append rows
...
# 1. Lieferschein aus Bestellung erzeugen
Given I open an editor "lieferschein1-815" from table "(Purchasing):(PackingSlip)" with command "NEW" for record ""
And I set field "beleg" to id from editor "bestellung-815"
And I set field "num4" to "815-LS1"
And I set field "ebeleg" to "Lieferschein1-815"
And I set field "vom" to "."
And I set field "ueb" to "ja"
And I set field "mge" to "200" in row 1
And I save the current editor

# 2. Lieferschein aus Bestellung mit Restmengenstorno erzeugen
Given I open an editor "lieferschein2-815" from table "(Purchasing):(PackingSlip)" with command "NEW" for record ""
And I set field "beleg" to id from editor "bestellung-815"
And I set field "num4" to "815-LS2"
And I set field "ebeleg" to "Lieferschein2_815"
And I set field "vom" to "."
And I set field "ueb" to "ja"
...
# 2. Lieferschein stornieren
Given I open an editor "stornols" from table "(Purchasing):(PackingSlip)" with command "REVERSAL" for record from editor "lieferschein2-815"
And I set field "num4" to "815-SLS"
And I save the current editor

# Bestellung kommt aus der Ablage
Given I open an editor "bestellung-815P" from table "(Purchasing):(PurchaseOrder)" with command "VIEW" for record from editor "bestellung-815"
Then field "ablagef" has value "nein"
Then field "ablagef" has value "nein" in row 1
And I close the current editor
...
@FALL-816
@persistent
Scenario: FALL-816 Bestellung kommt aus der Ablage nach Storno des Lieferschein vor Restmengenstornos

# Konto 816-FALL mit Steuerregel
Given I open an editor "konto" from table "(Account):(Account)" with command "COPY" for record "10000"
And I set field "nummer" to "0816FALL"
And I set field "such" to "FALL-816"
And I set field "ktostrgl" to "EKIN-ALL"
And I save the current editor
...
And I set field "nummer" to "0816FALL"
And I set field "such" to "FALL-816"
And I set field "bestausekso" to "FALL-816"
And I save the current editor

# Artikel anlegen
Given I open an editor "artikel" from table "(Part):(Product)" with command "STORE" for record "816-FALL"
And I set field "num2" to "816-FALL"
And I set field "such" to "FALL-816"
And I set field "namebspr" to "FALL-816"
And I set field "bsart" to "Fremdbeschaffung"
And I set field "dispoa" to "bedarfsbezogen"
And I set field "lief" to "1"
And I set field "wgruppe" to "FALL-816"
And I set field "erlgrp" to "66"
And I set field "ekbewverf" to "6"
And I set field "wgruppe" to "FALL-816"
And I save the current editor
...
# Bestellung anlegen
Given I open an editor "bestellung-816" from table "(Purchasing):(PurchaseOrder)" with command "NEW" for record ""
And I set fields
    | lief   | 1      |
    | num4   | 816-BE |
And I append rows
...
# 1. Lieferschein aus Bestellung erzeugen
Given I open an editor "lieferschein1-816" from table "(Purchasing):(PackingSlip)" with command "NEW" for record ""
And I set field "beleg" to id from editor "bestellung-816"
And I set field "num4" to "816-LS1"
And I set field "ebeleg" to "Lieferschein1-816"
And I set field "vom" to "."
And I set field "ueb" to "ja"
...
# 2. Lieferschein aus Bestellung mit Restmengenstorno erzeugen
Given I open an editor "lieferschein2-816" from table "(Purchasing):(PackingSlip)" with command "NEW" for record ""
And I set field "beleg" to id from editor "bestellung-816"
And I set field "num4" to "816-LS2"
And I set field "ebeleg" to "Lieferschein2_816"
And I set field "vom" to "."
And I set field "ueb" to "ja"
And I set field "mge" to "25" in row 1
And I respond with answer "Ja" to the dialog with id "191"
...
# 1. Lieferschein stornieren
Given I open an editor "stornols" from table "(Purchasing):(PackingSlip)" with command "REVERSAL" for record from editor "lieferschein1-816"
And I set field "num4" to "816-SLS"
And I save the current editor

# Bestellung kommt aus der Ablage
Given I open an editor "bestellung-816P" from table "(Purchasing):(PurchaseOrder)" with command "VIEW" for record from editor "bestellung-815"
Then field "ablagef" has value "nein"
Then field "ablagef" has value "nein" in row 1
And I close the current editor
