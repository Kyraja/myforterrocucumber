...
# Rechnung anlegen
Given I open an editor "rechnung-123" from table "(Purchasing):(Invoice)" with command "NEW" for record ""
...
# Anzahlungsrechnung kann wieder erstellt werden
Given I open an editor "rechnung-245" from table "(Sales):(Invoice)" with command "NEW" for record ""
And I set field "vorganga" to "(Downpayment)"
And I set field "beleg" to id from editor "auftrag-245"
And I set field "nummer" to "245-AR2"
And I set field "vom" to "."
And I set field "ueb" to "ja"
And I set field "pwert" to "1000" in row 1
And I set field "kenn" to "FALL-245Bis"
And I respond with answer "Ja" to the dialog with id "4841"
And I save the current editor

# Ausgabe Anzahlungsrechnung
Given I open an editor "rechnung-view" from table "(Sales):(Invoice)" with command "VIEW" for record "+245-AR2"
And I close the current editor
...
And I set field "artprg" to "321-FALL" in row 1
And I set field "artrab" to "321-FALL" in row 1
...
# Ausgabe Ruecklieferschein
Given I open an editor "rueckls792-view" from table "(Sales):(PackingSlip)" with command "VIEW" for record "+792-RELS"
And I close the current editor
...
Scenario: Kontenrechnungzwang wird zwischen Rechnungsbuchung und Stornierung geaendert, Storno der RE muss gelingen.

# Konto anlegen mit ausgeschaltetem Kostenrechnungszwang
Given I open an editor "Konto50010" from table "(Account):(Account)" with command "COPY" for record "44000"
And I set fields
 | nummer   |      50010 |
 | hkost    |       nein |
 | kost     |       nein |
...
# Rechnung anlegen
Given I open an editor "rechnungKTO" from table "(Sales):(Invoice)" with command "NEW" for record ""
And I set fields
 | num3  |1-ReKto |
 | kunde |   1    |
 | ueb   |  ja    |
...
And I set field "kenn" to "FALL-1"
And I set field "konto" to "50010" in row 1
And I respond with answer "Ja" to the dialog with id "4841"
And I save the current editor

# Kostenrechnungszwang aktivieren
Given I open an editor "KTOrezwang" from table "(Account):(Account)" with command "UPDATE" for record "50010"
...
# Rechnung stornieren
Given I open an editor "rechnungStr" from table "(Sales):(Invoice)" with command "REVERSAL" for record "+1-ReKto"
And I set field "nummer" to "1-StrKto"
And I save the current editor

# Rechnung 1-RechKto abgelegt
Then "(Sales):(Invoice)" with the editor id "rechnungKTO" is filed

####################################################################################################################################

@FALL-794
Scenario: FALL-794 Auftrag bleibt in der Ablage nach Storno der Ueberlieferung

# Konto 794-FALL mit Steuerregel
Given I open an editor "konto" from table "(Account):(Account)" with command "COPY" for record "10000"
And I set field "nummer" to "0794FALL"
And I set field "such" to "FALL-794"
And I set field "ktostrgl" to "EKIN-ALL"
And I save the current editor
...
And I set field "nummer" to "0794FALL"
And I set field "such" to "FALL-794"
And I set field "bestausekso" to "FALL-794"
And I save the current editor

# Artikel anlegen
Given I open an editor "artikel" from table "(Part):(Product)" with command "STORE" for record "794-FALL"
And I set field "num2" to "794-FALL"
And I set field "such" to "FALL-794"
And I set field "namebspr" to "FALL-794"
And I set field "bsart" to "Fremdbeschaffung"
And I set field "dispoa" to "bedarfsbezogen"
And I set field "lief" to "1"
And I set field "wgruppe" to "FALL-794"
And I set field "erlgrp" to "66"
And I set field "ekbewverf" to "6"
And I save the current editor
...
# Auftrag anlegen
Given I open an editor "auftrag-794" from table "(Sales):(SalesOrder)" with command "NEW" for record ""
And I set fields
    | num3  | 794-AU |
    | kunde | 1      |
And I append rows
...
# 1. Lieferschein aus Auftrag mit Restmengenstorno erzeugen
Given I open an editor "lieferschein1-794" from table "(Sales):(PackingSlip)" with command "NEW" for record ""
And I set field "beleg" to id from editor "auftrag-794"
And I set field "num3" to "794-LS1"
And I set field "vom" to "."
And I set field "ueb" to "ja"
...
# 2. Lieferschein aus Auftrag mit Ueberlieferung erzeugen
Given I open an editor "lieferschein2-794" from table "(Sales):(PackingSlip)" with command "NEW" for record ""
And I set field "beleg" to id from editor "auftrag-794"
And I set field "num3" to "794-LS2"
And I set field "vom" to "."
And I set field "ueb" to "ja"
And I set field "mge" to "1" in row 1
And I save the current editor
...
Given I open an editor "stornols" from table "(Sales):(PackingSlip)" with command "REVERSAL" for record from editor "lieferschein2-794"
And I set field "num3" to "793-SLS"
And I save the current editor

# Auftrag ist in der Ablage
Given I open an editor "auftrag-794P" from table "(Sales):(SalesOrder)" with command "VIEW" for record from editor "auftrag-794"
...
@FALL-795
Scenario: FALL-795 Auftrag kommt aus der Ablage nach Storno des Lieferschein mit Ueberlieferung

# Konto 795-FALL mit Steuerregel
Given I open an editor "konto" from table "(Account):(Account)" with command "COPY" for record "10000"
And I set field "nummer" to "0795FALL"
And I set field "such" to "FALL-795"
And I set field "ktostrgl" to "EKIN-ALL"
And I save the current editor
...
And I set field "nummer" to "0795FALL"
And I set field "such" to "FALL-795"
And I set field "bestausekso" to "FALL-795"
And I save the current editor

# Artikel anlegen
Given I open an editor "artikel" from table "(Part):(Product)" with command "STORE" for record "795-FALL"
And I set field "num2" to "795-FALL"
And I set field "such" to "FALL-795"
And I set field "namebspr" to "FALL-795"
And I set field "bsart" to "Fremdbeschaffung"
And I set field "dispoa" to "bedarfsbezogen"
And I set field "lief" to "1"
And I set field "wgruppe" to "FALL-795"
And I set field "erlgrp" to "66"
And I set field "ekbewverf" to "6"
And I save the current editor
...
# Auftrag anlegen
Given I open an editor "auftrag-795" from table "(Sales):(SalesOrder)" with command "NEW" for record ""
And I set fields
    | num3  | 795-AU |
    | kunde | 1 |
And I append rows
...
# 1. Lieferschein aus Auftrag erzeugen
Given I open an editor "lieferschein1-795" from table "(Sales):(PackingSlip)" with command "NEW" for record ""
And I set field "beleg" to id from editor "auftrag-795"
And I set field "num3" to "795-LS1"
And I set field "vom" to "."
And I set field "ueb" to "ja"
...
# 2. Lieferschein aus Auftrag mit Ueberlieferung erzeugen
Given I open an editor "lieferschein2-795" from table "(Sales):(PackingSlip)" with command "NEW" for record ""
And I set field "beleg" to id from editor "auftrag-795"
And I set field "num3" to "795-LS2"
And I set field "vom" to "."
And I set field "ueb" to "ja"
And I set field "mge" to "1" in row 1
And I save the current editor
...
# 2. Lieferschein stornieren
Given I open an editor "stornols" from table "(Sales):(PackingSlip)" with command "REVERSAL" for record from editor "lieferschein2-795"
And I set field "num3" to "795-SLS"
And I save the current editor

# Auftrag ist wieder lebendig
Given I open an editor "auftrag-795P" from table "(Sales):(SalesOrder)" with command "VIEW" for record from editor "auftrag-795"
...
@FALL-796
Scenario: FALL-796 Auftrag kommt aus der Ablage nach Storno des Lieferschein mit Restmengenstorno

# Konto 796-FALL mit Steuerregel
Given I open an editor "konto" from table "(Account):(Account)" with command "COPY" for record "10000"
And I set field "nummer" to "0796FALL"
And I set field "such" to "FALL-796"
And I set field "ktostrgl" to "EKIN-ALL"
And I save the current editor
...
And I set field "nummer" to "0796FALL"
And I set field "such" to "FALL-796"
And I set field "bestausekso" to "FALL-796"
And I save the current editor

# Artikel anlegen
Given I open an editor "artikel" from table "(Part):(Product)" with command "STORE" for record "796-FALL"
And I set field "num2" to "796-FALL"
And I set field "such" to "FALL-796"
And I set field "namebspr" to "FALL-796"
And I set field "bsart" to "Fremdbeschaffung"
And I set field "dispoa" to "bedarfsbezogen"
And I set field "lief" to "1"
And I set field "wgruppe" to "FALL-796"
And I set field "erlgrp" to "66"
And I set field "ekbewverf" to "6"
And I save the current editor
...
# Auftrag anlegen
Given I open an editor "auftrag-796" from table "(Sales):(SalesOrder)" with command "NEW" for record ""
And I set fields
    | num3  | 796-AU |
    | kunde | 1      |
And I append rows
...
# 1. Lieferschein aus Auftrag erzeugen
Given I open an editor "lieferschein1-796" from table "(Sales):(PackingSlip)" with command "NEW" for record ""
And I set field "beleg" to id from editor "auftrag-796"
And I set field "num3" to "796-LS1"
And I set field "vom" to "."
And I set field "ueb" to "ja"
And I set field "mge" to "32" in row 1
And I save the current editor

# 2. Lieferschein aus Auftrag mit Restmengenstorno erzeugen
Given I open an editor "lieferschein2-796" from table "(Sales):(PackingSlip)" with command "NEW" for record ""
And I set field "beleg" to id from editor "auftrag-796"
And I set field "num3" to "796-LS2"
And I set field "vom" to "."
And I set field "ueb" to "ja"
...
# 2. Lieferschein stornieren
Given I open an editor "stornols" from table "(Sales):(PackingSlip)" with command "REVERSAL" for record from editor "lieferschein2-796"
And I set field "num3" to "796-SLS"
And I save the current editor

# Auftrag kommt aus der Ablage
Given I open an editor "auftrag-796P" from table "(Sales):(SalesOrder)" with command "VIEW" for record from editor "auftrag-796"
Then field "ablagef" has value "nein"
Then field "ablagef" has value "nein" in row 1
And I close the current editor
...
@FALL-797
Scenario: FALL-797 Auftrag kommt aus der Ablage nach Storno des Lieferschein vor Restmengenstorno

# Konto 797-FALL mit Steuerregel
Given I open an editor "konto" from table "(Account):(Account)" with command "COPY" for record "10000"
And I set field "nummer" to "0797FALL"
And I set field "such" to "FALL-797"
And I set field "ktostrgl" to "EKIN-ALL"
And I save the current editor
...
And I set field "nummer" to "0797FALL"
And I set field "such" to "FALL-797"
And I set field "bestausekso" to "FALL-797"
And I save the current editor

# Artikel anlegen
Given I open an editor "artikel" from table "(Part):(Product)" with command "STORE" for record "797-FALL"
And I set field "num2" to "797-FALL"
And I set field "such" to "FALL-797"
And I set field "namebspr" to "FALL-797"
And I set field "bsart" to "Fremdbeschaffung"
And I set field "dispoa" to "bedarfsbezogen"
And I set field "lief" to "1"
And I set field "wgruppe" to "FALL-797"
And I set field "erlgrp" to "66"
And I set field "ekbewverf" to "6"
And I save the current editor
...
# Auftrag anlegen
Given I open an editor "auftrag-797" from table "(Sales):(SalesOrder)" with command "NEW" for record ""
And I set fields
    | num3  | 797-AU |
    | kunde | 1      |
And I append rows
...
# 1. Lieferschein aus Auftrag erzeugen
Given I open an editor "lieferschein1-797" from table "(Sales):(PackingSlip)" with command "NEW" for record ""
And I set field "beleg" to id from editor "auftrag-797"
And I set field "num3" to "797-LS1"
And I set field "vom" to "."
And I set field "ueb" to "ja"
...
# 2. Lieferschein aus Auftrag mit Restmengenstorno erzeugen
Given I open an editor "lieferschein2-797" from table "(Sales):(PackingSlip)" with command "NEW" for record ""
And I set field "beleg" to id from editor "auftrag-797"
And I set field "num3" to "797-LS2"
And I set field "vom" to "."
And I set field "ueb" to "ja"
...
Given I open an editor "stornols" from table "(Sales):(PackingSlip)" with command "REVERSAL" for record from editor "lieferschein1-797"
And I set field "num3" to "797-SLS"
And I save the current editor

# Auftrag kommt aus der Ablage
Given I open an editor "auftrag-797P" from table "(Sales):(SalesOrder)" with command "VIEW" for record from editor "auftrag-797"
Then field "ablagef" has value "nein"
Then field "ablagef" has value "nein" in row 1
And I close the current editor
