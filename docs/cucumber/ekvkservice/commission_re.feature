@include @persistent
Feature: Daten fuer Provisionsabrechnung erstellen nach Rechnungsstellung
Background:
Given I set the fake date to "02.01.1995"
Given I set saved value "REF_FILE" to "VK.COMMISSION.CU.RE.REF"
...
Scenario:  Infosystem starten COMMISSION zum Tagesdatum mit Kriterium "Provisionierung nach Zahlungseingang"
#Es sind andere Kopffelder gefüllt als bei Auswertung nach Rechnungsstellung
#bezprovibetr=0, provisoffen<>0
