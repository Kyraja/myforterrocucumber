# *****************************************************************************
#  Name           : kv_kempf_ohne_zwang.feature             
#  Autor          : sih
#  Verantwortlich : sih
#  Kontrolle      : uo
#  Funktion       : Test des Verwendens von Kostenverteilern, die nur Kostenobjekte, nur Kostenempfänger oder beides enthalten 
#                   im Kontext ohne Kore-Zwang.
#                   Für Test vor/ohne Zwang: bei Verwendung von Konto 54000 mal Kostenobjekte weglassen im Kostenverteiler.
# *****************************************************************************
@persistent
Feature: ref_kv_kempfvor_kore_startdat_cu und ref_kv_kempf_nach_kore_startdat_cu
Background: 
# Startdatum Kore 12/00
Given I set the fake date to "1.08.00"

Scenario: Buchungen
#
# Buchung-1
# Zeile 1: Konto 54000 (mit Korezwang),  mehrzeiliger dyn. KV ohne Kostenobjekt, mit Kostenempfänger
# Zeile 2: Konto 54000,                  kein Kostenverteiler/Kostenobjekt   
# Zeile 3: Konto 54000,                  mehrzeiliger dyn. KV teilweise mit Kostenobjekt, teilweise mit Kostenempfänger   
# Zeile 4: Konto 55000 (ohne Korezwang), mehrzeiliger dyn. KV teilweise mit Kostenobjekt, mit Kostenempfänger     
#
#
...
#
# Buchung-2
# Zeile 1: Konto 54000 (mit Korezwang),  einzeiliger dyn. KV ohne Kostenobjekt, mit Kostenempfänger
# Zeile 2: Konto 55000 (ohne Korezwang), einzeiliger dyn. KV mit Kostenobjekt, mit Kostenempfänger     
#
