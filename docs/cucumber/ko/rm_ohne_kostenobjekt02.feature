@persistent
Feature: ref_rm_ohne_kostenobjekt_fkv_aus_mkv_*
Background:
Given I set the fake date to "02.01.2002"

# *****************************************************************************
#  Name             : rm_ohne_kostenobjekt02.feature
#  Autor            : Silvia Warth
#  Verantwortlich   : sih
#  Kontrolle        : uo
...
Scenario: 01 Entfernen der Kst in der Maschinengruppe 101 und der ABteilung 10
...
Given I open an editor "mgr" from table "(Capacity):(Department)" with command "UPDATE" for record "A1"
And I set field "kstelle" to ""
And I save the current editor
...
Scenario: 02 Rückmeldung auf ersten Arbeitsgang
