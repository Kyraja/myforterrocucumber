# *****************************************************************************
#  Name             : steuerobjekte_brexit_laenderabhaengig_005_wgs.feature
#  Autor            : wane
#  Verantwortlich   : wane
#  Kontrolle        :
...
Then field "budat" has value "07.07.02"
Then field "vrgstrgl" has value "VKEUSTFR"
Then field "ophist" has value "OP25VK-RE1"
And I set fields
   | nummer | 25vk-wgs|
   | such   | wgs25   |
   | tterm  | .       |
...
Then table has values
    ...
    | EK1-FALL26 | -30 | 3.33  | 0     | EKEUWARE | 1      | 36fall26 |
    | EK1-FALL26 | -20 | 5.20  | 0     | EKEUWARE | 1      | 36fall26 |
And I set field "intrarel" to "nein" in row 1
...
Then table has values
    | art        | mge | preis | ofmge | strgl    | steuer | konto    |
    | EK1-FALL27 | -20 | 5.60  | 0     | EKEUWARE | 1      | 36fall27 |
And I set field "intrarel" to "nein" in row 1
And I respond with answer "ja" to the dialog with id "4841"
And I save the current editor
And I close the current editor
...
Then table has values
    | art        | mge | preis | ofmge | strgl    | steuer | konto    |
    | EK1-FALL28 | -20 | 5.60  | 0     | EKEUWARE | 1      | 36fall28 |
And I set field "intrarel" to "nein" in row 1
And I respond with answer "ja" to the dialog with id "4841"
And I save the current editor
And I close the current editor
