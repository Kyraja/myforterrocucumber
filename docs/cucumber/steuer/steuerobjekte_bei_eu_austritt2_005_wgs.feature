# *****************************************************************************
#  Name             : steuerobjekte_bei_eu_austritt2_005_wgs.feature
#  Autor            : wane
#  Verantwortlich   : wane
#  Kontrolle        :
...
Given I set the fake date to "01.08.2002"
...
Given I set the fake date to "2.08.2002"
...
Then field "budat" has value "02.08.02"
...
And I set fields
   ...
   | ueb    | ja      |
Then field "wertgutschrift" has value "ja" in row 0
Then field "budat" has value "02.08.02" in row 0
Then field "vrgstrgl" has value "EKAUSLSTFR" in row 0
Then field "ustart" has value "steuerfrei" in row 0
Then field "stlaart" has value "Ausland" in row 0
...
Given I set the fake date to "03.08.2002"
...
Then the table has 5 rows
Then field "strgl" has value "EKEUWARE" in row 1
Then field "konto" has value "1efall28" in row 1
Then field "steuer" has value "1" in row 1
#
And I set field "vom" to "."
And I set field "budat" to "."
...
Then the table has 1 rows
Then field "strgl" has value "EKAUFREI" in row 1
Then field "konto" has value "1afall28" in row 1
Then field "steuer" has value "0" in row 1
