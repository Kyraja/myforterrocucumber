#!/bin/sh
#
#  Shellskript fr Aufruf allpstart/FOP.PRJM.PVORGANGSTATISTIK.CRON 
#
...
protokolldatei=$MANDANTDIR/allpstart/FOP.PRJM.PVORGANGSTATISTIK.CRON.PROT
#  date +%Y%m%d%H%M%S
# Logrotation
...
$HOMEDIR/bin/batchlg.sh -PASSARGS allpstart/FOP.PRJM.PVORGANGSTATISTIK.CRON 1>>$protokolldatei 2>&1
