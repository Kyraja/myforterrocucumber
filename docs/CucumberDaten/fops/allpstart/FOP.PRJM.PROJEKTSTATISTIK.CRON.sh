#!/bin/sh
#
#  Shellskript fr Aufruf allpstart/FOP.PRJM.PROJEKTSTATISTIK.CRON
#
...
protokolldatei=$MANDANTDIR/allpstart/FOP.PRJM.PROJEKTSTATISTIK.CRON.PROT
#  date +%Y%m%d%H%M%S
# Logrotation
...
$HOMEDIR/bin/batchlg.sh -PASSARGS allpstart/FOP.PRJM.PROJEKTSTATISTIK.CRON 1>>$protokolldatei 2>&1
