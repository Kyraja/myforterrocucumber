/**
 * @module TableFieldSelect
 * Collection of four related searchable-dropdown / combobox components for
 * selecting abas ERP tables and fields:
 *   - TableSelect  – standalone dropdown returning a full TableDef on selection.
 *   - FieldSelect  – standalone dropdown returning a full FieldDef on selection.
 *   - FieldCombobox – inline text input with live-filtered field suggestions,
 *     keeping the raw string value in state (used inside step rows).
 *   - TableCombobox – inline text input with live-filtered table suggestions,
 *     firing both onChange (string) and onSelect (TableDef) callbacks.
 * All variants are localisation-aware and cap results at 100 entries.
 */
