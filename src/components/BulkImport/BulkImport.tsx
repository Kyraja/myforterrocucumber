/**
 * @module BulkImport
 * Batch AI generation panel that processes multiple work packages from an XLSX file.
 *
 * Key responsibilities:
 * - Parses uploaded XLSX files into WorkPackage objects via parseWorkPackageXlsx.
 * - Drives sequential AI Gherkin generation for all packages using the useBulkGeneration hook.
 * - Displays per-package status (pending / generating / done / error) with retry and download actions.
 * - Allows downloading all completed .feature files as a ZIP archive.
 * @prop {string} model - AI model identifier to use for generation.
 * @prop {string} testUser - Default test user name injected into generated scenarios.
 * @prop {TableDef[]} tables - Available table definitions for context-aware generation.
