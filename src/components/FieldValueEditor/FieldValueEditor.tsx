/**
 * @module FieldValueEditor
 * Simple list editor for key/value pairs (FieldValue[]). Renders a labelled
 * two-column row per entry with text inputs for field name and value, plus
 * add/remove controls. Used to specify field-level pre-conditions and
 * expected outcomes inside a Gherkin scenario step.
 *
 * Key props: `values` – current list of field–value pairs; `onChange` – called
 * with the updated list; `fieldLabel`/`valueLabel` – optional column headings.
 */
