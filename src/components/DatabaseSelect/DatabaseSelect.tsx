/**
 * @module DatabaseSelect
 * Searchable dropdown for selecting an abas ERP database (AbasDatabase).
 * Filters the full database list by ID, software key, or localised name and
 * shows up to 50 results. Once a database is selected it renders a dismissible
 * chip instead of the input field.
 *
 * Key props: `value` – currently selected database or null; `onChange` – called
 * with the chosen database or null when cleared.
 */
