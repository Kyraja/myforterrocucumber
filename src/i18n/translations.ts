...
export interface Translations {
  ...
  'dataimport.addColumn': string;
  'dataimport.addColumnPrompt': string;
  'dataimport.columnExists': string;
  'dataimport.aiHints': string;
  'dataimport.applyHint': string;
  'dataimport.applyAllHints': string;
  'dataimport.mappingTab': string;
  'dataimport.structuralHintsTab': string;
  'dataimport.contentHintsTab': string;
  'dataimport.applyAiMappingsDirectly': string;
  'dataimport.splitColumn': string;
  'dataimport.splitColumnInstruction': string;
  'dataimport.cleanupProposal': string;
  'dataimport.importItTitle': string;
  'dataimport.importItExport': string;
  'dataimport.importItTableStart': string;
  'dataimport.importItTableStartHint': string;
  'dataimport.importItOptionCode': string;
  'dataimport.importItOptionCodeAuto': string;
  'dataimport.importItSml': string;
  'dataimport.importItFieldOptions': string;
  'dataimport.importItNeedsDatabase': string;
  'dataimport.importItNeedsFields': string;
  'dataimport.importItReorder': string;
  'dataimport.importItOptionCreateNew': string;
  'dataimport.importItOptionDisableFop': string;
  'dataimport.importItOptionClearTable': string;
  'dataimport.importItOptionCheckModifiable': string;
  'dataimport.importItOptionEnglishVariables': string;
  'dataimport.importItOptionDontChangeIfEqual': string;
  'dataimport.importItOptionCheckForbiddenChars': string;
...
const de: Translations = {
  ...
  'form.aiEditPlaceholder': 'z.B. Ersetze in allen Steps K durch T, oder erstelle den gleichen Test für Kunde XYZ mit abweichenden Feldern.',
  ...
  'settings.manualOpenLogin': 'Login-Seite öffnen',
  'settings.manualCodePlaceholder': 'Code oder Callback-URL einfügen',
  'settings.manualCodeExchange': 'Code einlösen',
  'settings.manualCodeHint': 'Nach dem Login den Code aus der URL kopieren und hier einfügen.',
  'settings.tokenUrl': 'Token-URL',
  'settings.applicationId': 'Application ID',
  'settings.applicationIdHint': 'Zielanwendung für Token-Scoping',
  'settings.loadingModels': 'Lade Modelle...',
  'settings.loginError': 'Login fehlgeschlagen',
  'settings.noTenants': 'Keine Tenants gefunden',
  'settings.noModels': 'Keine Modelle verfügbar',
  ...
  'settings.sharedChooseFolder': 'Ordner wählen',
  'settings.sharedFolderMissing': 'Pflicht: Kein Ordner gewählt',
  'settings.sharedRequiredHint': 'Shared Settings sind Pflicht: erst Ordner wählen, dann Import/Export verwenden.',
  'settings.sharedFolderRequiredError': 'Bitte zuerst einen Shared-Settings-Ordner wählen (Pflicht).',
  'settings.sharedChooseFolderError': 'Ordner konnte nicht gewählt werden',
  'settings.sharedSaveError': 'Shared Settings konnten nicht gespeichert werden',
  'settings.sharedInvalidJsonError': 'Ungültige Settings-JSON',
  ...
  'help.appendRows': 'Zeilen anfügen (mit Datentabelle)',
  'help.appendRowsDesc': 'Mehrere Zeilen kompakt anfügen',
  ...
  'help.usageExportFeature': '.feature herunterladen: Über den Download-Button in der Vorschau wird das aktuelle Feature als .feature-Datei gespeichert.',
  ...
  'help.usageCsvDesc': 'Über "Variablentabelle hochladen" in der Toolbar kann eine CSV- oder XLSX-Datei mit Tabellen- und Felddefinitionen geladen werden. Danach stehen die Felder bei der Datenbank-Suche und in den Step-Feldern als Autovervollständigung zur Verfügung.',
  ...
  'docx.skipped': ', {count} übersprungen',
  'docx.loading': 'Dokument wird verarbeitet...',
  'docx.emptyTitle': 'Konzept-Dokument importieren',
  'docx.emptyDesc1': 'Laden Sie ein Word-Dokument (.docx) hoch, das Ihre Test-Features enthält.',
  'docx.emptyDesc2': 'Verwenden Sie Überschriften (H1/H2) um Features voneinander zu trennen.',
  ...
  'docx.tokenLimitReached': 'MyForterro-Tageslimit für KI-Anfragen erreicht. Die Generierung wurde gestoppt — bitte morgen erneut versuchen.',
  ...
  'docx.noFeatures': 'Keine Features im Dokument erkannt. Verwenden Sie Überschriften (H1/H2) als Trennung.',
  ...
  'docx.efkAgentName': 'Name für den EFK-Agent:',
  'docx.noAgent': 'Ohne Agent',
  'docx.selectExistingAgent': 'Bestehenden Agent auswählen',
  'docx.newAgent': 'Neuen Agent erstellen',
  'docx.noAgentSelected': '-- Agent auswählen --',
  'docx.agentRequired': 'Bitte wählen oder erstellen Sie einen EFK-Agent',
  'docx.agentActive': 'Agent: {name}',
  'docx.agentCreating': 'Agent wird erstellt...',
  'docx.deleteEfkAgent': 'Agent löschen',
  'docx.efkAgentCreated': 'EFK-Agent erstellt',
  'docx.efkChat': 'Chat mit Agent',
  'docx.efkChatHint': 'Hinweis: Der Agent kennt nur die Arbeitspakete, die bereits bewertet oder generiert wurden — nicht das vollständige EFK-Dokument.',
  ...
  'docx.skippedChapters': 'Übersprungene Kapitel',
  ...
  'settings.profileDelete': 'Löschen',
  ...
  'settings.profileNewName': 'Name für neues Profil:',
  'settings.profileNewDefault': 'Mein Profil',
  'settings.profileInvalid': 'Ungültige Profil-Datei.',
  ...
  'agent.noModelWarning': 'Kein Modell ausgewählt. Bitte in den Einstellungen ein Modell wählen.',
  ...
  'concept.gapsTitle': 'Übergreifende Lücken',
  ...
  'token.limitReachedToast': 'Tageslimit für KI-Anfragen erreicht. Bitte morgen erneut versuchen.',
  ...
  'token.estimatedTitle': 'Geschätzt (clientseitig tokenisiert) — Server-Report nicht verfügbar',
  'token.estimated': '~ geschätzt',
  ...
  'docx.aiTimeoutHint': 'Timeout gilt pro KI-Request je Arbeitspaket (nicht für das gesamte Konzept).',
  'docx.relationAnalyzing': 'Zusammenhänge werden analysiert ...',
  ...
  'docx.relationAnalyzeAll': 'Zusammenhänge aller Kapitel analysieren ({count})',
  'docx.relationAnalyzingShort': 'Analysiere ...',
  'docx.tocTitle': 'Inhaltsverzeichnis — {fileName}',
  'docx.selectAll': 'Alles auswählen',
  'docx.deselectAll': 'Alles abwählen',
  'docx.onlyAbas': 'Nur Abas ({count})',
  'docx.onlyCustomer': 'Nur Kunde ({count})',
  'docx.legendPackage': '☑ Arbeitspaket (für KI-Generierung)',
  'docx.legendSkipped': '— Kein Customizing (übersprungen)',
  ...
  'docx.inconsistenciesLabel': 'Widersprüche',
  ...
  'docx.relationDependsOn': 'hängt ab von',
  'docx.relationSameData': 'gleiches Objekt',
  'docx.relationSameProcess': 'gleicher Prozess',
  'docx.relationPreconditionFor': 'Voraussetzung für',
  'docx.relationBelongsTo': 'gehört zu',
  'docx.linkedChapters': 'Verknüpfte Kapitel',
  'docx.packages': 'Pakete',
  'docx.done': 'fertig',
  'docx.errors': 'Fehler',
  'docx.sessionExpired': 'Sitzung abgelaufen. Bitte erneut anmelden.',
  'docx.noAgentAvailable': 'Kein Agent verfügbar.',
  ...
  'docx.chunks': 'Chunks',
  'docx.chapterRelations': 'Kapitel-Zusammenhänge',
  'docx.analysisChunk': 'Analyse-Chunk',
  'docx.prepareChunk': 'Chunk vorbereiten',
  'docx.packagesInChunk': 'Pakete im Chunk',
  'docx.analyzeRelationsAi': 'Zusammenhänge analysieren (KI)',
  'docx.jsonRepair': 'JSON-Reparatur',
  'docx.invalidResponseTryingRepair': 'Antwort ungültig, versuche automatische Reparatur',
  'docx.repairResponseJsonAi': 'Antwort in JSON reparieren (KI)',
  'docx.chunkSkipped': 'Chunk übersprungen',
  'docx.jsonStillInvalidAfterRepair': 'JSON trotz Reparatur ungültig',
  'docx.chunkParsed': 'Chunk geparst',
  'docx.relationsLabel': 'Relationen',
  'docx.clustersLabel': 'Cluster',
  'docx.mergeChunkResultsAi': 'Chunk-Ergebnisse zusammenführen (KI)',
  ...
  'docx.relationsTitle': 'Zusammenhänge',
  ...
  'docx.linkedLabel': 'Zusammengehörig',
  'docx.selectLinkedChapter': 'Zielkapitel auswählen',
  'docx.deleteLink': 'Verbindung löschen',
  'docx.deleteRelationGroup': 'Zusammenhang löschen',
  ...
  'app.sharedSettingsChecking': 'Prüfe Shared Settings ...',
  'app.sharedSettingsRequiredTitle': 'Shared-Settings-Ordner ist Pflicht',
  'app.sharedSettingsRequiredDesc': 'Ohne ausgewählten Shared-Settings-Ordner kann die Anwendung nicht gestartet werden.',
  'app.sharedSettingsChooseFolder': 'Shared-Settings-Ordner wählen',
  ...
  'app.noAgentAvailable': 'Kein Agent verfügbar.',
  'app.currentFile': 'Aktuelle Datei',
  'app.aiEditUnknownError': 'Unbekannter Fehler bei der KI-Änderung.',
  'app.newFeatureFallback': 'Neues Feature',
  'app.workflowDiagram': 'Workflow-Diagramm',
  'app.stepsCount': '{count} Schritte',
  'app.editorPlaceholderOpenFolder': 'Öffne einen Ordner im Explorer, um Feature-Dateien zu bearbeiten.',
  'app.editorPlaceholderSelectFile': 'Wähle eine Feature-Datei aus dem Explorer, um sie zu bearbeiten.',
  'app.editorPlaceholderShowExplorer': 'Explorer einblenden (📁 oder Ctrl+B), um eine Feature-Datei auszuwählen.',
  'app.noAgentAvailableExplain': 'Kein Agent verfügbar. Bitte zuerst einen Agent erstellen (Konzept-Import oder Ordner-Agent).',
  'app.toolbox': 'Baukasten',
  'app.reload': 'Neu laden',
  'app.removeFolder': 'Ordner entfernen',
  'app.openFopFolder': 'FOP-Ordner öffnen',
  'app.fromExplorer': 'Aus Explorer',
  'app.openLearningDashboard': 'Learning-Dashboard öffnen',
  'app.learnings': 'Learnings',
  'app.exportBusinessHeading': 'Fachliche Beschreibung',
  'app.exportUseCasesHeading': 'Anwendungsfälle',
  ...
  'app.resetEverything': 'Alles zurücksetzen?',
  ...
  'toolbox.selectForExport': 'Für Export auswählen',
  'toolbox.customTemplate': 'Eigene Vorlage',
  'toolbox.suggested': 'Vorgeschlagen',
  'toolbox.deleteTemplateTitle': 'Vorlage löschen?',
  'toolbox.delete': 'Löschen',

  // StammdatenView
  'stammdaten.assumeExistsHint': 'Wenn aktiv: KI verwendet vorhandene Datensätze statt neue anzulegen (STORE/NEW)',
  ...
  'dataimport.addColumn': 'Spalte hinzufügen',
  'dataimport.addColumnPrompt': 'Name der neuen Spalte:',
  'dataimport.columnExists': 'Diese Spalte existiert bereits.',
  'dataimport.aiHints': 'KI-Hinweise',
  'dataimport.applyHint': 'Übernehmen',
  'dataimport.applyAllHints': 'Alle Hinweise übernehmen',
  'dataimport.mappingTab': 'Zuordnung',
  'dataimport.structuralHintsTab': 'Strukturelle Hinweise',
  'dataimport.contentHintsTab': 'Inhaltliche Hinweise',
  'dataimport.applyAiMappingsDirectly': 'KI-Feldvorschläge direkt übernehmen',
  'dataimport.splitColumn': 'Spalte aufteilen',
  'dataimport.splitColumnInstruction': 'Teile die Spalte "{column}" in eigene Spalten auf und benenne die neuen Spalten eindeutig.',
  'dataimport.cleanupProposal': 'KI-Bereinigungsvorschlag',
  'dataimport.importItTitle': 'ImportIT-Export',
  'dataimport.importItExport': 'ImportIT-Datei exportieren',
  'dataimport.importItTableStart': 'Tabellendaten ab Spalte',
  'dataimport.importItTableStartHint': '0 = keine Tabellenfelder',
  'dataimport.importItOptionCode': 'Optionscode',
  'dataimport.importItOptionCodeAuto': 'Automatisch',
  'dataimport.importItSml': 'Sachmerkmalsleiste',
  'dataimport.importItFieldOptions': 'ImportIT-Optionen',
  'dataimport.importItNeedsDatabase': 'Bitte zuerst eine Datenbank zuordnen.',
  'dataimport.importItNeedsFields': 'Bitte zuerst mindestens ein Feld zuordnen.',
  'dataimport.importItReorder': 'Reihenfolge per Drag and Drop ändern',
  'dataimport.importItOptionCreateNew': 'Datensätze neu anlegen',
  'dataimport.importItOptionDisableFop': 'FOP deaktivieren',
  'dataimport.importItOptionClearTable': 'Tabelle löschen',
  'dataimport.importItOptionCheckModifiable': 'Feld-Modifizierbarkeit prüfen',
  'dataimport.importItOptionEnglishVariables': 'Englische Variablennamen',
  'dataimport.importItOptionDontChangeIfEqual': 'Ändere nicht bei gleichem Inhalt',
  'dataimport.importItOptionCheckForbiddenChars': 'Strings auf verbotene Zeichen prüfen',
  ...
  'stammdaten.selectDatabase': 'Datenbank auswählen',
  'stammdaten.selectInfosystem': 'Infosystem auswählen',
  'stammdaten.selectMask': 'Maske auswählen',
  ...
  // AgentActivityModal
  'agentActivity.status.running': 'Läuft',
  ...
  'agentActivity.activity': 'Aktivität',
  'agentActivity.historyCount': 'Verlauf ({count})',
  'agentActivity.systemPrompt': 'System-Prompt',
  'agentActivity.back': 'Zurück',
  'agentActivity.delete': 'Löschen',
  'agentActivity.promptHint': 'Aktuell aktiver System-Prompt dieses Agents. Änderbar in den Einstellungen.',
  ...
  'csv.clearAllData': 'Alle Stammdaten löschen',
  'csv.clear': 'Löschen',
  'csv.pasteFopPlaceholder': 'Inhalt von FOP.txt hier einfügen...',

  // UploadPanel
  'upload.directoryPickerUnsupported': 'Ihr Browser unterstützt die Directory Picker API nicht.',
  'upload.fopFolder': 'FOP-Ordner',
  'upload.noFolderSelected': 'Kein Ordner ausgewählt',
  'upload.loadingFops': 'FOPs werden geladen...',
  'upload.opening': 'Öffne...',
  'upload.useExplorerFolder': 'Aktuell geöffneten Explorer-Ordner verwenden',
  'upload.useFromExplorer': 'Aus Explorer übernehmen',
  ...
  // DocxImport — confirm dialogs
  'docx.autoAnalyzeTitle': 'Zusammenhänge analysieren?',
  'docx.autoAnalyzeMessage': 'Möchtest du nach dem Upload direkt die Zusammenhänge aller Kapitel analysieren?\n\nDu kannst die Analyse auch später manuell starten.',
  'docx.yes': 'Ja',
...
const en: Translations = {
  ...
  'dataimport.addColumn': 'Add column',
  'dataimport.addColumnPrompt': 'Name of the new column:',
  'dataimport.columnExists': 'This column already exists.',
  'dataimport.aiHints': 'AI hints',
  'dataimport.applyHint': 'Apply',
  'dataimport.applyAllHints': 'Apply all hints',
  'dataimport.mappingTab': 'Mapping',
  'dataimport.structuralHintsTab': 'Structural hints',
  'dataimport.contentHintsTab': 'Content hints',
  'dataimport.applyAiMappingsDirectly': 'Apply AI field suggestions directly',
  'dataimport.splitColumn': 'Split column',
  'dataimport.splitColumnInstruction': 'Split column "{column}" into separate columns and name the new columns clearly.',
  'dataimport.cleanupProposal': 'AI cleanup proposal',
  'dataimport.importItTitle': 'ImportIT export',
  'dataimport.importItExport': 'Export ImportIT file',
  'dataimport.importItTableStart': 'Table data from column',
  'dataimport.importItTableStartHint': '0 = no table fields',
  'dataimport.importItOptionCode': 'Option code',
  'dataimport.importItOptionCodeAuto': 'Automatic',
  'dataimport.importItSml': 'Variant item',
  'dataimport.importItFieldOptions': 'ImportIT options',
  'dataimport.importItNeedsDatabase': 'Please assign a database first.',
  'dataimport.importItNeedsFields': 'Please assign at least one field first.',
  'dataimport.importItReorder': 'Reorder via drag and drop',
  'dataimport.importItOptionCreateNew': 'Always create new records',
  'dataimport.importItOptionDisableFop': 'Disable FOP',
  'dataimport.importItOptionClearTable': 'Clear table',
  'dataimport.importItOptionCheckModifiable': 'Check field modifiability',
  'dataimport.importItOptionEnglishVariables': 'English variable names',
  'dataimport.importItOptionDontChangeIfEqual': 'Do not change if equal',
  'dataimport.importItOptionCheckForbiddenChars': 'Check strings for forbidden characters',
